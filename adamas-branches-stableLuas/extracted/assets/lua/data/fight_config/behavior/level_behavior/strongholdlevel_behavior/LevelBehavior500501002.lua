LevelBehavior500501002 = BaseClass("LevelBehavior500501002",LevelBehaviorBase)
--小据点
function LevelBehavior500501002.GetGenerates()
	local generates = {2010604,790007000,790014000,900020,791002500}
	return generates
end


function LevelBehavior500501002:Init()
	self.missionState = 0
	self.tipsState = 0
	...
	self.FxShieldEcoId = 3003001020006
...
function LevelBehavior500501002:Update()
	...
	if self.missionState == 0 then
		self.FxPrisonLinelockId = BehaviorFunctions.CreateEntityByPosition(2010604,nil,"PrisonLinelockPos",nil,500501002,self.levelId)

		--创建怪物
		self.monsterListInfo = self.LevelCommon:LevelCreateMonster(self.monsterList)
		self.shilongId = BehaviorFunctions.CreateEntityByPosition(791002500,nil,"YuelingPos",nil,500501002,self.levelId)
	...
	if self.tipsState == 0 then
		local pos1 = BehaviorFunctions.GetTerrainPositionP("SmallPos2",10020005,"StrongholdEvent")
...
function LevelBehavior500501002:Death(instanceId, isFormationRevive)

end


function LevelBehavior500501002:WorldInteractClick(uniqueId, instanceId)
...
function LevelBehavior500501002:RemoveLevel(levelId)
...
function LevelBehavior500501002:FinishLevel()
	
end

--赋值
function LevelBehavior500501002:Assignment(variable,value)
	self[variable] = value
end
