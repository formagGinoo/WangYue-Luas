...
function UnlockWindow:__Hide()
    ...
    if self.isUnlockFail then
        ...
        BehaviorFunctions.fight.clientFight.cameraManager:SetMainTarget(playerObject.clientEntity.clientTransformComponent.transform)
    end
...
function UnlockWindow:UnlockSucToCameraState()
    ...
    if doorInsid then
        ...
        local trans = doorEntity.clientEntity.clientTransformComponent.transform
