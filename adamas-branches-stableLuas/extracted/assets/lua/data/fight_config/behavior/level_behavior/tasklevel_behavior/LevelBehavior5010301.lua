LevelBehavior5010301 = BaseClass("LevelBehavior5010301",LevelBehaviorBase)

function LevelBehavior5010301.GetGenerates()
	local generates = {900140,910040}
	return generates
end

function LevelBehavior5010301:__init(fight)
	self.fight = fight
end

function LevelBehavior5010301:Init()
	...
	self.monsterList =
	{
		{id = 900140 ,posName = "Mon0101" ,wave = 1},
		{id = 900140 ,posName = "Mon0102" ,wave = 1},
		{id = 900140 ,posName = "Mon0103" ,wave = 1},
...
function LevelBehavior5010301:Update()
	...
	elseif self.missionState == 1 then
		...
		--if self.LevelCommon:SuccessCondition_DefeatAllEnemy(self.monsterListInfo) then
			...
			--BehaviorFunctions.FinishLevel(5010301)	
