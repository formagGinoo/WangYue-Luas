Config = Config or {}
Config.Entity808012001 = Config.Entity808012001 or { }
local empty = { }
Config.Entity808012001 = 
{
  [ 808012001 ] = {
    EntityId = 808012001,
    Components = {
            ...
            BoneColliders = {
              {
                ...
                LocalPosition = { 0.0, 0.5666666, 0.0 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 0.333333343, 0.5666667, 0.333333343 }
              }
            },
            LogicSearch = true,
            SearchWeight = 0.0,
            ...
            BoneColliders = {
              {
                ...
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 0.459082216, 0.268765062, 0.459082216 }
              }
            },
            DefaultEnable = true,
            ColliderFollow = 1,
      ...
      HackingInputHandle = {
        HackingType = 5,
        Name = "脉灵",
        Icon = "Textures/Icon/Single/HeadIcon/SquNMailing.png",
        Desc = "能够通过与其进行同调以调查事件",
        EffectType = 2,
        ...
        UpHackingClickType = {
          ButtonIcon = "hack_mailing",
          HackingButtonName = "同调",
          CostElectricity = 0,
          HackingRam = 0,
          HackingDesc = "脉灵同调"
        },
