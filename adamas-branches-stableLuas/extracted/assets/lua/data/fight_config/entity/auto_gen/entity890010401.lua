Config = Config or {}
Config.Entity890010401 = Config.Entity890010401 or { }
local empty = { }
Config.Entity890010401 = 
{
  [ 890010401 ] = {
    EntityId = 890010401,
    Components = {
      Transform = {
        Prefab = "Character/Monster/Elaizumale/ElaizumaleMo1/ElaizumaleMo1.prefab",
        Model = "ElaizumaleMo1",
        isClone = false,
        MinDistance = 0.5,
        MaxDistance = 1.5,
      ...
      Animator = {
        Animator = "Character/Monster/Elaizumale/ElaizumaleMo1/ElaizumaleMo1.controller",
