LevelBehavior3001 = BaseClass("LevelBehavior3001",LevelBehaviorBase)
--关卡测试关
function LevelBehavior3001:__init(fight)
	self.fight = fight
end


function LevelBehavior3001.GetGenerates()
...
function LevelBehavior3001:Init()
	self.role = 1
	self.missionState = 0
	self.monster1 = 0
	self.monster2 = 0
...
function LevelBehavior3001:Update()
...
--死亡事件
function LevelBehavior3001:RemoveEntity(instanceId)
...
function LevelBehavior3001:__delete()

end

function LevelBehavior3001:GMSetMonsterId(id)
