LevelBehavior405010413 = BaseClass("LevelBehavior405010413",EntityBehaviorBase)
--摄像头玩法关卡1
function LevelBehavior405010413:__init(fight)
	self.fight = fight
end

function LevelBehavior405010413.GetGenerates()
...
function LevelBehavior405010413:Init()
	...
	self.cameraList = {
		[1] = {bp = "Camera031", Id = nil , entityId = 2030504}, --室内1
		[2] = {bp = "Camera032", Id = nil , entityId = 2030504}, --室内2
		[3] = {bp = "Camera033", Id = nil , entityId = 2030504}, --室内3
		[4] = {bp = "Camera034", Id = nil , entityId = 2030529}, --室外1
		[5] = {bp = "Camera035", Id = nil , entityId = 2030504}, --室内4
		[6] = {bp = "Camera036", Id = nil , entityId = 2030504}, --室内4
	}
	
	
	self.monsterList = {
		[1] = {bp = "Luohou031", Id = nil , entityId = 900070}, --小怪1
		[2] = {bp = "Luohou032", Id = nil , entityId = 8010005}, --小怪2
		[3] = {bp = "Luohou033", Id = nil , entityId = 900070}, --小怪3
		[4] = {bp = "Luohou034", Id = nil , entityId = 900070}, --小怪4
	}
	
	
	self.missionList = {
		[1] = {bp = "Computer031", Id = nil , entityId = 2030513}, --任务道具1
		[2] = {bp = "Computer032", Id = nil , entityId = 2030513}, --任务道具2
		[3] = {bp = "Audio031", Id = nil , entityId = 2030514}, --任务道具3
	}
...
function LevelBehavior405010413:LateInit()
	
	
end

function LevelBehavior405010413:Update()
...
--肉鸽追踪
function LevelBehavior405010413:RogueGuidePointer(guidePos,guideDistance,guideType)
...
--进入实体范围
function LevelBehavior405010413:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
--退出实体范围
function LevelBehavior405010413:ExitTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	if roleInstanceId == self.role then
		if triggerInstanceId == self.levelFlag then
...
--实体按钮交互
function LevelBehavior405010413:WorldInteractClick(uniqueId,instanceId)
...
--检查电脑有没有被看管
function LevelBehavior405010413:ComputerByGuard(computerId,guardId,watchangle)
...
--给电脑上锁
function LevelBehavior405010413:LockComputer(computerId)
...
function LevelBehavior405010413:StoryPassEvent(dialogId)
...
function LevelBehavior405010413:StoryEndEvent(dialogId)
	--结束罗睺的警告动画之后
...
--function LevelBehavior405010413:Death(instanceId,isFormationRevive)
...
----重置关卡
--function LevelBehavior405010413:Remark()
--end

--点击骇入按钮的上键
function LevelBehavior405010413:HackingClickUp(instanceId)
