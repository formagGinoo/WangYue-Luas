Config = Config or {}
Config.Entity800100801 = Config.Entity800100801 or { }
local empty = { }
Config.Entity800100801 = 
{
  [ 800100801 ] = {
    EntityId = 800100801,
    Components = {
      Transform = {
        Prefab = "Character/Role/Female165/TianhulianR21/TianhulianR21M11/TianhulianR21M11.prefab",
        Model = "TianhulianR21M11",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
      ...
      Animator = {
        Animator = "Character/Role/Female165/TianhulianR21/TianhulianR21M11/TianhulianR21M11.controller",
      ...
      HackingInputHandle = {
        HackingType = 3,
        Name = "NPC模板",
        Icon = "Textures/Icon/Single/HeadIcon/SquMBaxilikesi.png",
        Desc = "这个是NPC模板，是拿来复制的，别直接用",
        EffectType = 2,
