...
function Behavior200000108:WorldInteractClick(uniqueId)
...
function Behavior200000108:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	...
	self.interactUniqueId = BehaviorFunctions.WorldInteractActive(WorldEnum.InteractType.Item,200001,"开启挑战", 1)
end
