...
function LevelBehavior30010:CastSkill(instanceId,skillId,skillSign,skillType)
...
function LevelBehavior30010:BreakSkill(instanceId,skillId,skillSign,skillType)
	--关闭技能记数
	if  instanceId == self.role then
...
function LevelBehavior30010:FinishSkill(instanceId,skillId,skillSign,skillType)
	--关闭技能记数
	if  instanceId == self.role then
		if self.hitKey == true then
			self.hitKey = false
