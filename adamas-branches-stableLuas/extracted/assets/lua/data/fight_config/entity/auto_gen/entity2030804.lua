Config = Config or {}
Config.Entity2030804 = Config.Entity2030804 or { }
local empty = { }
Config.Entity2030804 = 
{
  [ 2030804 ] = {
    EntityId = 2030804,
    Components = {
      Transform = {
        Prefab = "CommonEntity/ElectChargeDevice/Prefab/ElectChargeDevice.prefab",
        Model = "ElectChargeDevice",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
        ...
        PartList = {
          {
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                LocalPosition = { 0.0, 0.6544878, 0.115350723 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 1.43074036, 1.57804847, 1.36828232 },
      ...
      Animator = {
        Animator = "CommonEntity/ElectChargeDevice/Prefab/ElectChargeDevice.controller",
        AnimationConfigID = "",
  ...
  [ 203080401 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "CommonEntity/ElectChargeDevice/Effect/FxElectChargeDevice_Enegy01.prefab",
        Model = "FxElectChargeDevice_Enegy01",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 203080402 ] = {
    ...
    Components = {
      Effect = {
        IsHang = true,
        IsBind = true,
        BindTransformName = "ElectChargeDevice_01b",
        IsBindWeapon = false,
        BindOffset = { 0.0, 0.0, 0.0 },
        ScaleOffset = { 0.0, 0.0, 0.0 },
        HitEffectBornType = 1,
      ...
      Transform = {
        Prefab = "CommonEntity/ElectChargeDevice/Effect/FxElectChargeDevice_Enegy02.prefab",
        Model = "FxElectChargeDevice_Enegy02",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 203080403 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "CommonEntity/ElectChargeDevice/Effect/FxElectChargeDevice_02.prefab",
        Model = "FxElectChargeDevice_02",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 203080404 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "CommonEntity/ElectChargeDevice/Effect/FxElectChargeDevice_03.prefab",
        Model = "FxElectChargeDevice_03",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 203080405 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "CommonEntity/ElectChargeDevice/Effect/FxElectChargeDevice_01.prefab",
        Model = "FxElectChargeDevice_01",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
