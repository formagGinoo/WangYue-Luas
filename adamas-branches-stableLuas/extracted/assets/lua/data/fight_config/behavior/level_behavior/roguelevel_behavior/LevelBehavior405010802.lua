LevelBehavior405010802 = BaseClass("LevelBehavior405010802",LevelBehaviorBase)
--烽火挑战

function LevelBehavior405010802.GetGenerates()
	local generates = {
		790012000,790013000,790007001,790008000, --小怪
		910040, --精英
		2041001,--信号塔
		2030206 --道具
	}
...
function LevelBehavior405010802:__init(fight)
	----敌人参数------------------------------------------------------------------------------------------------------------------------------------------
	...
	self.enemyList = {
		...
		[2] = {towerPos = "Pos1", state = self.monsterStateEnum.Default, monsterId = 790013000, posName = "_EnemyBorn2", Id = nil, tage = "Enemy"},
		[3] = {towerPos = "Pos1", state = self.monsterStateEnum.Default, monsterId = 790012000, posName = "_EnemyBorn3", Id = nil, tage = "Enemy"},
		[4] = {towerPos = "Pos1", state = self.monsterStateEnum.Default, monsterId = 2030206, posName = "_ItemBorn1", Id = nil, tage = "Item"},
		--Pos2敌人和道具选择
		[5] = {towerPos = "Pos2", state = self.monsterStateEnum.Default, monsterId = 790012000, posName = "_EnemyBorn1", Id = nil, tage = "Enemy"},
		[6] = {towerPos = "Pos2", state = self.monsterStateEnum.Default, monsterId = 790012000, posName = "_EnemyBorn2", Id = nil, tage = "Enemy"},
		[7] = {towerPos = "Pos2", state = self.monsterStateEnum.Default, monsterId = 790008000, posName = "_EnemyBorn3", Id = nil, tage = "Enemy"},
		[8] = {towerPos = "Pos2", state = self.monsterStateEnum.Default, monsterId = 2030206, posName = "_ItemBorn1", Id = nil, tage = "Item"},
		--Pos3敌人和道具选择
		[9] = {towerPos = "Pos3", state = self.monsterStateEnum.Default, monsterId = 790008000, posName = "_EnemyBorn1", Id = nil, tage = "Enemy"},
		[10] = {towerPos = "Pos3", state = self.monsterStateEnum.Default, monsterId = 790008000, posName = "_EnemyBorn2", Id = nil, tage = "Enemy"},
		[11] = {towerPos = "Pos3", state = self.monsterStateEnum.Default, monsterId = 2030206, posName = "_ItemBorn1", Id = nil, tage = "Item"},
	}
...
function LevelBehavior405010802:Init()
	self.missionState = 0
...
function LevelBehavior405010802:Update()
...
--生成敌人
function LevelBehavior405010802:enemySpawn(enemyList,PosList)
...
--生成信号塔
function LevelBehavior405010802:TowerSpawn(towerList,PosList)
	for x,y in ipairs(PosList) do
...
function LevelBehavior405010802:EnterArea(triggerInstanceId, areaName, logicName)
...
function LevelBehavior405010802:ExitArea(triggerInstanceId, areaName, logicName)
	if areaName == "eventZone" and triggerInstanceId == self.role then
		self.leaveArea = true
		--LogError("playerExit")
	end
...
function LevelBehavior405010802:Die(attackInstanceId,dieInstanceId)
...
--检查塔对应敌人的状态
function LevelBehavior405010802:CheckTowerState()
	for i,v in ipairs(self.posList) do
...
--检查塔对应敌人的状态
function LevelBehavior405010802:CheckTowerStateShowTip()
	for i,v in ipairs(self.posList) do
...
--玩家点击后，检查哪些塔完成了
function LevelBehavior405010802:WorldInteractClick(uniqueId,instanceId)
	for i,v in ipairs(self.posList) do
...
--全队死亡判定失败
function LevelBehavior405010802:Death(instanceId,isFormationRevive)
...
--任务前置肉鸽追踪指标
function LevelBehavior405010802:RogueGuidePointer(guidePos,guideDistance,guideType)
	local playerPos = BehaviorFunctions.GetPositionP(self.role)
...
--肉鸽追踪（给信号塔添加标记）
function LevelBehavior405010802:TowerGuidePointer()
	for i,v in ipairs(self.posList) do
		--如果信号塔已经被关闭则不添加标记
...
--信号塔完成时添加指标
function LevelBehavior405010802:TowerFinishedGuidePointer()
	for i,v in ipairs(self.posList) do
		--如果信号塔已经被关闭则不添加标记
