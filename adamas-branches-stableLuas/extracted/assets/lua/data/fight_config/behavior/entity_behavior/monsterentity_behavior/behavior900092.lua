Behavior900092 = BaseClass("Behavior900092",EntityBehaviorBase)
...
function Behavior900092.GetGenerates()
	local generates = {}
	return generates
end


function Behavior900092:Init()
...
function Behavior900092:Update()
	self.role = BehaviorFunctions.GetCtrlEntity()
	local firstPos = BehaviorFunctions.GetTerrainPositionP("XW21",10020004,"PV999")
	local sayPos = BehaviorFunctions.GetTerrainPositionP("XW22",10020004,"PV999")
	local lastPos = BehaviorFunctions.GetTerrainPositionP("XW23",10020004,"PV999")
	...
	--对话
	if self.missionState == 2 and not self.insay then
...
function Behavior900092:StoryEndEvent(dialogId)
	if dialogId == 601011401 then
		BehaviorFunctions.CastSkillBySelfPosition(self.me,90009004)
	end
end
	
function Behavior900092:FinishSkill(instanceId,skillId,skillSign,skillType)
