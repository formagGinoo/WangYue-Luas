...
function Behavior2010101:WorldInteractClick(uniqueId)
...
function Behavior2010101:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	...
	if self.entityId and self.entityId == 2010101 then
		self.interactUniqueId = BehaviorFunctions.WorldInteractActive(WorldEnum.InteractType.Chest,nil,"雀铜宝藏",1)
	elseif self.entityId and self.entityId == 2010102 then
		self.interactUniqueId = BehaviorFunctions.WorldInteractActive(WorldEnum.InteractType.Chest,nil,"燕铁宝藏",1)
	elseif self.entityId and self.entityId == 2010103 then
		self.interactUniqueId = BehaviorFunctions.WorldInteractActive(WorldEnum.InteractType.Chest,nil,"鹰银宝藏",1)
	elseif self.entityId and self.entityId == 2010104 then
		self.interactUniqueId = BehaviorFunctions.WorldInteractActive(WorldEnum.InteractType.Chest,nil,"鹤金宝藏",1)
	end
end
