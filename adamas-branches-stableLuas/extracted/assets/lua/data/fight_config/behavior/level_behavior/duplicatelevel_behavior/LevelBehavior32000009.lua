LevelBehavior32000009 = BaseClass("LevelBehavior32000009",LevelBehaviorBase)
--梦魇-初难度1-4


function LevelBehavior32000009.GetGenerates()
	local generates = {2000,790002000,791004000,790012000,790007100,790006000,790007000,790008000}
	return generates
end

function LevelBehavior32000009:__init(fight)
	self.fight = fight
end


function LevelBehavior32000009:Init()
	...
	self.monsterList =
	{
		[1] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 1 ,lev = 28 ,entityId = 790002000},  --1土石龙
		[2] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 1 ,lev = 28 ,entityId = 790008000},  --1箴石之劣_木
		[3] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon3" ,wave = 1 ,lev = 28 ,entityId = 790006000},  --1尾狐
		[4] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon4" ,wave = 1 ,lev = 28 ,entityId = 790007100},  --1斩客土
		[5] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 2 ,lev = 28 ,entityId = 790007000},  --2斩客
		[6] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 2 ,lev = 28 ,entityId = 790007000},  --2斩客
		[7] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon3" ,wave = 2 ,lev = 28 ,entityId = 790012000},  --2从士
		[8] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon4" ,wave = 2 ,lev = 28 ,entityId = 791004000},  --2精英从士
...
function LevelBehavior32000009:Update()
	...
	if self.missionState == 0 then
		...
		local fp1 = BehaviorFunctions.GetTerrainPositionP("mon2",32000009)
...
function LevelBehavior32000009:CreatMonster(wave)
...
function LevelBehavior32000009:Death(instanceId,isFormationRevive)
	--计算怪物全部死亡
	for i,v in ipairs(self.monsterList) do
		--计算当前波次怪物死亡数
...
--BehaviorFunctions.ShowTip(32000009)
--end
...
function LevelBehavior32000009:__delete()
