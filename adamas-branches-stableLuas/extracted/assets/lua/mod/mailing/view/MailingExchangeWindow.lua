...
local EffectDelayTime = 
{
	--[MailingMood.HappyEnd] = 1.8,
}
...
function MailingExchangeWindow:PlayMoodAnim(mood)
	...
	local delay = EffectDelayTime[mood]
	
	mod.MailingCtrl:PlayMailingAnim(self.instanceId, anim, effectId, delay)
end
