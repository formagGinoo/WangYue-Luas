LevelBehavior104030201 = BaseClass("LevelBehavior104030201",LevelBehaviorBase)
--遇到刻刻处

function LevelBehavior104030201:__init(fight)
	self.fight = fight
end

function LevelBehavior104030201.GetGenerates()
	local generates = {
        900040,   --木从士
        900041,   --火从士
        900042,   --冰从士
...
function LevelBehavior104030201:Init()
	self.missionState = 0
    self.role = nil
    self.posName = "SaveNpcPos"
	self.deathCount = 0
	self.monsterList = {
        900030,900060,900050
    }
end

function LevelBehavior104030201:Update()
	self.role = BehaviorFunctions.GetCtrlEntity()
    self:CreateMonster()
end

function LevelBehavior104030201:__delete()

end

--在某个点附近创建怪
function LevelBehavior104030201:CreateMonster()
...
--死亡事件
function LevelBehavior104030201:Death(instanceId,isFormationRevive)
...
function LevelBehavior104030201:LevelFinish()
