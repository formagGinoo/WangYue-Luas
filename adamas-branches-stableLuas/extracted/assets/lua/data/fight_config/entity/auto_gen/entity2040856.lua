Config = Config or {}
Config.Entity2040856 = Config.Entity2040856 or { }
local empty = { }
Config.Entity2040856 = 
{
  [ 2040856 ] = {
    EntityId = 2040856,
    Components = {
      Transform = {
        Prefab = "CommonEntity/Vehicle/LaHuoChe/Prefab/LaHuoChe00101.prefab",
        Model = "LaHuoChe00101",
        isClone = true,
        MinDistance = 0.0,
        MaxDistance = 1.0,
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                ParentName = "Collider",
                LocalPosition = { 0.0, 0.931, 0.02 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 2.17350841, 1.50269043, 4.905793 },
      ...
      Animator = {
        Animator = "CommonEntity/Vehicle/LaHuoChe/Animation/LaHuoChe001/LaHuoChe001.controller",
        AnimationConfigID = "",
