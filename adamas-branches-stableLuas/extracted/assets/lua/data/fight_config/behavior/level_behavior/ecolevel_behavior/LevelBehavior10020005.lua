LevelBehavior10020005 = BaseClass("LevelBehavior10020005",LevelBehaviorBase)
--生态behavior
function LevelBehavior10020005:__init(fight)
	self.fight = fight
end

function LevelBehavior10020005.GetGenerates()
	local generates = {2030201}
	return generates
end


function LevelBehavior10020005:Init()
	self.missionState = 0
	self.time = 0
	self.timeStart = 0
	self.playingBgm = ""
...
function LevelBehavior10020005:Update()
...
function LevelBehavior10020005:RemoveEntity(instanceId)

end

function LevelBehavior10020005:__delete()

end

function LevelBehavior10020005:PlayBgm(name)
