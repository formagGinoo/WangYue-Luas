Behavior2050102 = BaseClass("Behavior2050102",EntityBehaviorBase) --在怪物身上使用CheckEcoEntityGroup,来决定是否要调用这个函数。
--资源预加载
function Behavior2050102.GetGenerates()
	local generates = {}
	return generates
end

function Behavior2050102:Init()
...
function Behavior2050102:TreasureBox()
...
--如何只在死亡的时候触发(正常解锁逻辑)
function Behavior2050102:Death(instanceId,isFormationRevive)
