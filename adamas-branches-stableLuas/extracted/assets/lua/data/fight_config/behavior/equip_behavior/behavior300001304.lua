Behavior300001304 = BaseClass("Behavior300001301",EntityBehaviorBase)
function Behavior300001304.GetGenerates()


end

function Behavior300001304.GetMagics()
	local generates = {300001314}
	return generates
end

function Behavior300001304:Init()
	self.ecoEntitys = nil
	self.magicState = 0
...
function Behavior300001304:Update()
	self.time = BehaviorFunctions.GetEntityFrame(self.me)/30--时间

end

function Behavior300001304:Collide(attackInstanceId,hitInstanceId)
    if attackInstanceId == self.me 
		...
		if randomresult and randomresult<=30 then
			BehaviorFunctions.DoMagic(self.me,self.me,300001314,1)--火伤提升
