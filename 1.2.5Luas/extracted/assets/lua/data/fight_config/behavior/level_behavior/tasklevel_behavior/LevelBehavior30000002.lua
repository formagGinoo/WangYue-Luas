LevelBehavior30000002 = BaseClass("LevelBehavior30000002",LevelBehaviorBase)
--动态创建关卡1
function LevelBehavior30000002:__init(fight)
	self.fight = fight
end


function LevelBehavior30000002.GetGenerates()
...
function LevelBehavior30000002:Init()
	self.role = 1
	self.missionState = 0
end

function LevelBehavior30000002:Update()
...
--死亡事件
function LevelBehavior30000002:RemoveEntity(instanceId)
...
function LevelBehavior30000002:__delete()
