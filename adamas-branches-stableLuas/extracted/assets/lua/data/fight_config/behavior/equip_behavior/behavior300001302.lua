Behavior300001302 = BaseClass("Behavior300001302",EntityBehaviorBase)
function Behavior300001302.GetGenerates()


end

function Behavior300001302.GetMagics()
	local generates = {300001312}
	return generates
end

function Behavior300001302:Init()
	self.ecoEntitys = nil
	self.magicState = 0
...
function Behavior300001302:Update()
	self.time = BehaviorFunctions.GetEntityFrame(self.me)/30--时间

end

function Behavior300001302:Collide(attackInstanceId,hitInstanceId)
    if attackInstanceId == self.me 
		...
		if randomresult and randomresult<=30 then
			BehaviorFunctions.DoMagic(self.me,self.me,300001312,1)--火伤提升
