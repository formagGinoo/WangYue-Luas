Behavior920010 = BaseClass("Behavior920010",EntityBehaviorBase)
--资源预加载
function Behavior920010.GetGenerates()
...
function Behavior920010:Init()
	...
	self.MonsterCommonParam.walkSwitchTime = 3              --移动方向切换时间
...
function Behavior920010:Update()
	...
	if not BehaviorFunctions.GetEntityValue(self.me,"stopMove") then
...
--实体死亡后的行为：结束血条和强锁。
function Behavior920010:Death(instanceId,isFormationRevive)
...
--实体死亡播放动画期间的行为：溶解特效
function Behavior920010:DeathEnter(instanceId,isFormationRevive)
