Config = Config or {}
Config.Entity8011003 = Config.Entity8011003 or { }
local empty = { }
Config.Entity8011003 = 
{
  [ 8011003 ] = {
    EntityId = 8011003,
    Components = {
      Transform = {
        Prefab = "Character/Npc/Female165/FemaleNpc01003/FemaleNpc01003.prefab",
        Model = "FemaleNpc01003",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
      ...
      HackingInputHandle = {
        HackingType = 3,
        Name = "工人女",
        Icon = "Textures/Icon/Single/HeadIcon/SquNHuiguangqingtingnv.png",
        Desc = "",
        EffectType = 2,
