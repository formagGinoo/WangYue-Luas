LevelBehavior32000004 = BaseClass("LevelBehavior32000004",LevelBehaviorBase)
--梦魇测试副本


function LevelBehavior32000004.GetGenerates()
	local generates = {2000,900040,900041,900050,900051,910040}
	return generates
end

function LevelBehavior32000004:__init(fight)
	self.fight = fight
end


function LevelBehavior32000004:Init()
...
function LevelBehavior32000004:Update()
	...
	if self.missionState == 0 then
		...
		local fp1 = BehaviorFunctions.GetTerrainPositionP("mon2",32000004)
...
function LevelBehavior32000004:CreatMonster(wave)
...
function LevelBehavior32000004:Death(instanceId,isFormationRevive)
	--计算怪物全部死亡
	for i,v in ipairs(self.monsterList) do
		--计算当前波次怪物死亡数
...
function LevelBehavior32000004:__delete()
