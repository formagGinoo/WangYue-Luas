Config = Config or {}
Config.Entity8011012 = Config.Entity8011012 or { }
local empty = { }
Config.Entity8011012 = 
{
  [ 8011012 ] = {
    EntityId = 8011012,
    Components = {
      Transform = {
        Prefab = "Character/Npc/Female165/FemaleNpc01012/FemaleNpc01012.prefab",
        Model = "FemaleNpc01012",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
      ...
      Animator = {
        Animator = "Character/Npc/Female165/Common/NPCFemale165Face02.overrideController",
      ...
      HackingInputHandle = {
        HackingType = 3,
        Name = "警察",
        Icon = "Textures/Icon/Single/HeadIcon/SquNJingchanv.png",
        Desc = "是一名光荣的女性警察",
        EffectType = 2,
