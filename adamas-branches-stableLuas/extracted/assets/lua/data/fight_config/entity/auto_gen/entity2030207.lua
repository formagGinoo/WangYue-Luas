        ...
        PartList = {
          {
            ...
            BoneColliders = {
              {
                ShapeType = 3,
                LocalPosition = { 0.0, 1.42, 0.0 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 6.613408, 2.12484241, 6.613408 }
              }
            },
            LogicSearch = true,
            SearchWeight = 0.0,
  ...
  [ 203020701 ] = {
    ...
    Components = {
      Effect = {
        IsHang = false,
        IsBind = true,
        BindTransformName = "FirePoint",
        IsBindWeapon = false,
        BindOffset = { 0.0, 0.0, 0.0 },
        ScaleOffset = { 7.0, 7.0, 7.0 },
        HitEffectBornType = 1,
        HitEffectOffsetY = 0.0,
        IsHeightLimit = false
      },
      Transform = {
        Prefab = "Effect/Prefab/Fight/FxWeaknessFire.prefab",
        Model = "FxWeaknessFire",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
