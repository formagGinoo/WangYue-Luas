LevelBehavior32000304 = BaseClass("LevelBehavior32000304",LevelBehaviorBase)
--离歌野外副本
function LevelBehavior32000304:__init(fight)
	self.fight = fight
end

function LevelBehavior32000304.GetGenerates()
	local generates = {70920011}
	return generates
end

function LevelBehavior32000304.GetStorys()
	local storys = {101070102,101071001}
	return storys
end

----程序黑幕
--function LevelBehavior32000304.NeedBlackCurtain()
--return true
--end

function LevelBehavior32000304:Init()
...
function LevelBehavior32000304:Update()
...
function LevelBehavior32000304:WeakGuide(guideId)
...
function LevelBehavior32000304:RemoveEntity(instanceId)

end

function LevelBehavior32000304:__delete()

end

--死亡事件
function LevelBehavior32000304:Die(attackInstanceId,dieInstanceId)
...
--死亡动画后事件
function LevelBehavior32000304:Death(instanceId,isFormationRevive)
	--玩家角色全部死亡，副本失败
...
function LevelBehavior32000304:BgmChangeLogic(group,groupNum,memberNum)
	if group then
...
function LevelBehavior32000304:LevelLookAtPos(pos,type,frame,bindTransform)
...
function LevelBehavior32000304:DisablePlayerInput(isOpen,closeUI)
	--取消摇杆移动
...
function LevelBehavior32000304:StoryStartEvent(dialogId)
...
function LevelBehavior32000304:StoryEndEvent(dialogId)
	for i,v in ipairs(self.dialogList) do
		if dialogId == v.Id then
...
--复活逻辑
function LevelBehavior32000304:Revive(instanceId, entityId)
...
--赋值
function LevelBehavior32000304:Assignment(variable,value)
	self[variable] = value
end

function LevelBehavior32000304:DuplicateCountdownFinish()
	LogError("111")
end
