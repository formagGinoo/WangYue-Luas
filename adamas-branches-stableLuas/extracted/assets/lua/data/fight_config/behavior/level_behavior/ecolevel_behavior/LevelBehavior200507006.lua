LevelBehavior200507006 = BaseClass("LevelBehavior200507006",LevelBehaviorBase)
--关卡测试关
function LevelBehavior200507006:__init(fight)
	self.fight = fight
end


function LevelBehavior200507006.GetGenerates()
	local generates = {910025,808011003,80801000301,791002500}
	return generates
end

function LevelBehavior200507006.GetMagics()
	local generates = {8080100030101,8080100030102}
	return generates
end

function LevelBehavior200507006:Init()
	--通用参数---------------------------------------------------------------------------------------------------------------------
...
function LevelBehavior200507006:Update()
...
function LevelBehavior200507006:Death(instanceId,isFormationRevive)
...
function LevelBehavior200507006:Die(attackInstanceId,dieInstanceId)
...
function LevelBehavior200507006:DuplicateCountdownFinish()
...
function LevelBehavior200507006:TimerCountFinish(timerId)
	if self.npcDead == false or self.yuelingDead == false then
		--self.gameLeftTime = BehaviorFunctions.ReturnDuplicateCountdownRemain()
		--if self.gameLeftTime <= 0 then
		BehaviorFunctions.SetDuplicateResult(false)
...
function LevelBehavior200507006:OnCountDownFinishEvent(levelId)
