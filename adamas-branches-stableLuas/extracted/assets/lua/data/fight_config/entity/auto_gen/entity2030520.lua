Config = Config or {}
Config.Entity2030520 = Config.Entity2030520 or { }
local empty = { }
Config.Entity2030520 = 
{
  [ 2030520 ] = {
    EntityId = 2030520,
    Components = {
      Transform = {
        Prefab = "CommonEntity/ElectronicDoor/Prefab/ElectronicCameraController.prefab",
        Model = "ElectronicCameraController",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
      ...
      HackingInputHandle = {
        ...
        UpHackingClickType = {
          ButtonIcon = "hack_camera",
          HackingButtonName = "操控",
          CostElectricity = 0,
          HackingRam = 0,
          HackingDesc = "操控监控"
        },
