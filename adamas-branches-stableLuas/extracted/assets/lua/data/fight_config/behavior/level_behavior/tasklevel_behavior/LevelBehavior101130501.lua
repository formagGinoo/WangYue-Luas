LevelBehavior101130501 = BaseClass("LevelBehavior101130501",LevelBehaviorBase)
--悬天喽啰2只

function LevelBehavior101130501:__init(fight)
	self.fight = fight
end

function LevelBehavior101130501.GetGenerates()
	local generates = {790007001}
	return generates
end

function LevelBehavior101130501:Init()
	...
	self.TaskFightLevel.monsterList = {
		--第一波
		{entityId = 790007001, posName = "Cangku01", instanceId = nil, lev = 0, wave = 1, isDead = false},
		{entityId = 790007001, posName = "Cangku011", instanceId = nil, lev = 0, wave = 1, isDead = false},
		--第二波
...
function LevelBehavior101130501:Update()
	self.TaskFightLevel:Update()
end

function LevelBehavior101130501:__delete()
