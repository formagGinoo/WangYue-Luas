...
function BaseStageChangeTipPanel:ShowDetail()
    ...
    for i = 1, config.newStage do
        self["Stage"..i]:SetActive(i == config.newStage)
    end

    UtilsUI.SetEffectSortingOrder(self["22030_"..config.newStage], self.canvas.sortingOrder + 1)
    UtilsUI.SetEffectSortingOrder(self["22031_"..config.newStage].transform:GetChild(0).gameObject, self.canvas.sortingOrder)
    UtilsUI.SetEffectSortingOrder(self["22031_"..config.newStage].transform:GetChild(1).gameObject, self.canvas.sortingOrder + 2)
    self["22030_"..config.newStage]:SetActive(true)
    self["22031_"..config.newStage]:SetActive(true)
