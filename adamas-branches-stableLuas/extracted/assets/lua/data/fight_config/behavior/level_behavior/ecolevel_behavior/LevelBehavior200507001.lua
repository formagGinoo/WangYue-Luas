LevelBehavior200507001 = BaseClass("LevelBehavior200507001",LevelBehaviorBase)
--关卡测试关
function LevelBehavior200507001:__init(fight)
	self.fight = fight
end


function LevelBehavior200507001.GetGenerates()
	local generates = {900080,808011003,80801000301,790008000}
	return generates
end

function LevelBehavior200507001.GetMagics()
	local generates = {8080100030101,8080100030102}
	return generates
end

function LevelBehavior200507001:Init()
	--通用参数---------------------------------------------------------------------------------------------------------------------
	...
	self.monsterList = {
		...
		{id = 790008000,posName = "mon2", wave = 1}
		}
	----------------------------------------------------------
...
function LevelBehavior200507001:Update()
...
function LevelBehavior200507001:Death(instanceId,isFormationRevive)
...
function LevelBehavior200507001:Die(attackInstanceId,dieInstanceId)
...
function LevelBehavior200507001:DuplicateCountdownFinish()
...
function LevelBehavior200507001:TimerCountFinish(timerId)
	if self.npcDead == false or self.yuelingDead == false then
		--self.gameLeftTime = BehaviorFunctions.ReturnDuplicateCountdownRemain()
		--if self.gameLeftTime <= 0 then
		BehaviorFunctions.SetDuplicateResult(false)
...
function LevelBehavior200507001:OnCountDownFinishEvent(levelId)
