...
--死亡事件
function LevelBehavior101070101:Die(attackInstanceId,dieInstanceId)
	--如若巴西利克斯死亡
...
function LevelBehavior101070101:BgmChangeLogic(group,groupNum,memberNum)
	if group then
...
--赋值
function LevelBehavior101070101:Assignment(variable,value)
	self[variable] = value
end
