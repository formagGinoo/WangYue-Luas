...
function Behavior2020106:WorldInteractClick(uniqueId, instanceId)
...
function Behavior2020106:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	if BehaviorFunctions.CheckTaskId(102030401) then
		...
		self.interactUniqueId = BehaviorFunctions.WorldInteractActive(self.me,WorldEnum.InteractType.Transport,nil,"开门", 1)
