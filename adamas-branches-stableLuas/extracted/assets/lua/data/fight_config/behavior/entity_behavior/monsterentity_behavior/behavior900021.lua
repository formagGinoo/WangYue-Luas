Behavior900021 = BaseClass("Behavior900021",EntityBehaviorBase)
--资源预加载
function Behavior900021.GetGenerates()
	local generates = {}
	return generates
end
--mgaic预加载
function Behavior900021.GetMagics()
	local generates = {900000008,900000009}
	return generates
end

function Behavior900021:Init()
	...
	--被暗杀动作
	self.beAssassin = 900021009
	self.backHited = 900021062
	...
	self.MonsterCommonParam.warnSkillId =  900021901        --警告技能Id
	self.MonsterCommonParam.tauntSkillId = 900021005         --嘲讽技能
	...
	self.MonsterCommonParam.defaultSkillId = 900021001		        --默认技能id，追杀模式使用
...
function Behavior900021:Update()
...
function Behavior900021:DeathEnter(instanceId,isFormationRevive)
...
function Behavior900021:Die(attackInstanceId,dieInstanceId)
