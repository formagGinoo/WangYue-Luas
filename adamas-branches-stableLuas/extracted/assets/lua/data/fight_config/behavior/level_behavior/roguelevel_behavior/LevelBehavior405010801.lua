LevelBehavior405010801 = BaseClass("LevelBehavior405010801",LevelBehaviorBase)
--烽火挑战

function LevelBehavior405010801.GetGenerates()
	local generates = {
		790012000,790013000,--小怪
		2041001,--信号塔
		2030206 --道具
		}
	return generates
...
function LevelBehavior405010801:__init(fight)
----敌人参数------------------------------------------------------------------------------------------------------------------------------------------
	...
	self.enemyList = {
		--Pos1敌人和道具选择
		[1] = {towerPos = "Pos1", state = self.monsterStateEnum.Default, monsterId = 790012000, posName = "_EnemyBorn1", Id = nil, tage = "Enemy"},
		[2] = {towerPos = "Pos1", state = self.monsterStateEnum.Default, monsterId = 790012000, posName = "_EnemyBorn2", Id = nil, tage = "Enemy"},
		[3] = {towerPos = "Pos1", state = self.monsterStateEnum.Default, monsterId = 790013000, posName = "_EnemyBorn3", Id = nil, tage = "Enemy"},
		--Pos2敌人和道具选择
		[4] = {towerPos = "Pos2", state = self.monsterStateEnum.Default, monsterId = 790012000, posName = "_EnemyBorn1", Id = nil, tage = "Enemy"},
		[5] = {towerPos = "Pos2", state = self.monsterStateEnum.Default, monsterId = 790012000, posName = "_EnemyBorn2", Id = nil, tage = "Enemy"},
		[6] = {towerPos = "Pos2", state = self.monsterStateEnum.Default, monsterId = 790013000, posName = "_EnemyBorn3", Id = nil, tage = "Enemy"},
		[7] = {towerPos = "Pos2", state = self.monsterStateEnum.Default, monsterId = 2030206, posName = "_ItemBorn1", Id = nil, tage = "Item"},
		[8] = {towerPos = "Pos2", state = self.monsterStateEnum.Default, monsterId = 2030206, posName = "_ItemBorn2", Id = nil, tage = "Item"},
		--Pos3敌人和道具选择
		[9] = {towerPos = "Pos3", state = self.monsterStateEnum.Default, monsterId = 790012000, posName = "_EnemyBorn1", Id = nil, tage = "Enemy"},
		[10] = {towerPos = "Pos3", state = self.monsterStateEnum.Default, monsterId = 790013000, posName = "_EnemyBorn2", Id = nil, tage = "Enemy"},
		[11] = {towerPos = "Pos3", state = self.monsterStateEnum.Default, monsterId = 790012000, posName = "_EnemyBorn3", Id = nil, tage = "Enemy"},
		}
...
function LevelBehavior405010801:Init()
	self.missionState = 0
...
function LevelBehavior405010801:Update()
...
--生成敌人
function LevelBehavior405010801:enemySpawn(enemyList,PosList)
...
--生成信号塔
function LevelBehavior405010801:TowerSpawn(towerList,PosList)
	for x,y in ipairs(PosList) do
...
function LevelBehavior405010801:EnterArea(triggerInstanceId, areaName, logicName)
...
function LevelBehavior405010801:ExitArea(triggerInstanceId, areaName, logicName)
	if areaName == "eventZone" and triggerInstanceId == self.role then
		self.leaveArea = true
		--LogError("playerExit")
	end
...
function LevelBehavior405010801:Die(attackInstanceId,dieInstanceId)
...
--检查塔对应敌人的状态
function LevelBehavior405010801:CheckTowerState()
	for i,v in ipairs(self.posList) do
...
--检查塔对应敌人的状态
function LevelBehavior405010801:CheckTowerStateShowTip()
	for i,v in ipairs(self.posList) do
...
--玩家点击后，检查哪些塔完成了
function LevelBehavior405010801:WorldInteractClick(uniqueId,instanceId)
	for i,v in ipairs(self.posList) do
...
--全队死亡判定失败
function LevelBehavior405010801:Death(instanceId,isFormationRevive)
...
--任务前置肉鸽追踪指标
function LevelBehavior405010801:RogueGuidePointer(guidePos,guideDistance,guideType)
	local playerPos = BehaviorFunctions.GetPositionP(self.role)
...
--肉鸽追踪（给信号塔添加标记）
function LevelBehavior405010801:TowerGuidePointer()
	for i,v in ipairs(self.posList) do
		--如果信号塔已经被关闭则不添加标记
...
--信号塔完成时添加指标
function LevelBehavior405010801:TowerFinishedGuidePointer()
	for i,v in ipairs(self.posList) do
		--如果信号塔已经被关闭则不添加标记
