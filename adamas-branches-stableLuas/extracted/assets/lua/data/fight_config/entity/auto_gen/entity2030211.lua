Config = Config or {}
Config.Entity2030211 = Config.Entity2030211 or { }
local empty = { }
Config.Entity2030211 = 
{
  [ 2030211 ] = {
    EntityId = 2030211,
    Components = {
      ...
      Transform = {
        Prefab = "CommonEntity/PowderKeg/Prefab/PowderKeg_RigiBody.prefab",
        Model = "PowderKeg_RigiBody",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
