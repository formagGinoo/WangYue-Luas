...
--有效受击播放受击语音
function Behavior92001:Hit(attackInstanceId,hitInstanceId,hitType)
	if not BehaviorFunctions.HasBuffKind(hitInstanceId,900000040) then     --霸体检测
		if hitInstanceId == self.me then
			BF.DoEntityAudioPlay(self.me,"v_lige_0004",true,FightEnum.SoundSignType.Language)
		end
	end
end
