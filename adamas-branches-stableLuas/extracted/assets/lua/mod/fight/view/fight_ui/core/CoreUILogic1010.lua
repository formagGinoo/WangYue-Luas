CoreUILogic1010 = BaseClass("CoreUILogic1010", CoreUIBase)
...
function CoreUILogic1010:OnInit()
...
function CoreUILogic1010:GetPercent(value, maxValue)
...
function CoreUILogic1010:UpdatePercent(value, maxValue)
	self.value = value
...
function CoreUILogic1010:GetCyclePos()
...
function CoreUILogic1010:SwitchCoreUIType(type)
	local active = type == 2
...
function CoreUILogic1010:ShowEffect(entity, index, active)
...
function CoreUILogic1010:Cache()
	-- self.gradurationEffect = {}
	Fight.Instance.objectPool:Cache(CoreUILogic1010,self)
end