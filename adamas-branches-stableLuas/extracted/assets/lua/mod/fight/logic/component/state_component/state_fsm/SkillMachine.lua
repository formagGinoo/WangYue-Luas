...
function SkillMachine:CanFall()
	return self.entity.moveComponent.isAloft
end
...
function SkillMachine:CanIngoreLandHurt()
	local isPlayer = self.fight.playerManager:GetPlayer():GetEntityQTEIndex(self.entity.instanceId)
	if not isPlayer or not self.entity.skillComponent then
		return false
	end

	return self.entity.skillComponent:CheckCurSkillIsDropSkill()
end
