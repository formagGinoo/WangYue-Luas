Config = Config or {}
Config.Entity2030205 = Config.Entity2030205 or { }
local empty = { }
Config.Entity2030205 = 
{
  [ 2030205 ] = {
    EntityId = 2030205,
    Components = {
      ...
      Transform = {
        Prefab = "CommonEntity/Box/Prefab/Box2.prefab",
        Model = "Box2",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
            ...
            BoneColliders = {
              {
                ...
                LocalPosition = { 0.0, -0.063, 0.0 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 1.4, 1.1625, 1.325 }
              }
            },
            LogicSearch = true,
            SearchWeight = 0.0,
