LevelBehavior32000006 = BaseClass("LevelBehavior32000006",LevelBehaviorBase)
--梦魇-初难度1-1


function LevelBehavior32000006.GetGenerates()
	local generates = {2000,790012000,790013000,900050,900051,910040}
	return generates
end

function LevelBehavior32000006:__init(fight)
	self.fight = fight
end


function LevelBehavior32000006:Init()
	...
	self.monsterList =
	{
		[1] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 1 ,lev = 20 ,entityId = 790012000},  --1从士
		[2] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 1 ,lev = 20 ,entityId = 790013000},  --1从士射手
		[3] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon4" ,wave = 1 ,lev = 20 ,entityId = 790012000},  --1从士
		[4] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 2 ,lev = 20 ,entityId = 790012000},  --1从士
		[5] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 2 ,lev = 20 ,entityId = 790013000},  --1从士射手
		[6] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon4" ,wave = 2 ,lev = 20 ,entityId = 790012000},  --1从士
...
function LevelBehavior32000006:Update()
	...
	if self.missionState == 0 then
		...
		local fp1 = BehaviorFunctions.GetTerrainPositionP("mon2",32000006)
...
function LevelBehavior32000006:CreatMonster(wave)
...
function LevelBehavior32000006:Death(instanceId,isFormationRevive)
	--计算怪物全部死亡
	for i,v in ipairs(self.monsterList) do
		--计算当前波次怪物死亡数
...
function LevelBehavior32000006:__delete()
