Behavior2041104 = BaseClass("Behavior2041104",EntityBehaviorBase)
--生态玩法 - 链接电线 - 电路开关起点
function Behavior2041104.GetGenerates()
end
function Behavior2041104:Init()
...
function Behavior2041104:LateInit()
end
function Behavior2041104:Update()
...
function Behavior2041104:HackingClickUp(instanceId)
	if instanceId == self.me then
		if self.myState == self.myStateEnum.inactive then			--inactive = 1,--未激活状态
			...
			BehaviorFunctions.SetEntityValue(self.me,"wire",true)		--激活电线，变成黄色
			...
			BehaviorFunctions.SetEntityHackEnable(self.me,false)
			BehaviorFunctions.AddDelayCallByTime(3,BehaviorFunctions,BehaviorFunctions.SetEntityHackEnable,self.me,true)
			BehaviorFunctions.SetEntityValue(self.me,"wire",false)		--关闭电线，变成蓝色
