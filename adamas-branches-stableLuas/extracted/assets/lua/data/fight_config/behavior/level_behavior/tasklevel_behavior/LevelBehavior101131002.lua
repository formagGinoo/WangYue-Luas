LevelBehavior101131002 = BaseClass("LevelBehavior101131002",LevelBehaviorBase)
--打败会反水的悬天成员

function LevelBehavior101131002:__init(fight)
	self.fight = fight
end

function LevelBehavior101131002.GetGenerates()
	local generates = {790007001}
	return generates
end

function LevelBehavior101131002:Init()
	...
	self.TaskFightLevel.monsterList = {
		--第一波
		{entityId = 790007001, posName = "HideXuantian", instanceId = nil, lev = 0, wave = 1, isDead = false},
		--第二波
...
function LevelBehavior101131002:Update()
	self.TaskFightLevel:Update()
end

function LevelBehavior101131002:__delete()
