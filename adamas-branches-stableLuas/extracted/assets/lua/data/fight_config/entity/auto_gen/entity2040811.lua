Config = Config or {}
Config.Entity2040811 = Config.Entity2040811 or { }
local empty = { }
Config.Entity2040811 = 
{
  [ 2040811 ] = {
    EntityId = 2040811,
    Components = {
      Transform = {
        Prefab = "CommonEntity/Vehicle/PaoChe/Prefab/PaoChe00101.prefab",
        Model = "PaoChe00101",
        isClone = true,
        MinDistance = 0.0,
        MaxDistance = 1.0,
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                ParentName = "Collider",
                LocalPosition = { 0.0, 0.85, -0.045 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 2.17350841, 1.2077179, 5.174325 },
      ...
      Animator = {
        Animator = "CommonEntity/Vehicle/PaoChe/Animation/PaoChe001/PaoChe001.controller",
        AnimationConfigID = "",
