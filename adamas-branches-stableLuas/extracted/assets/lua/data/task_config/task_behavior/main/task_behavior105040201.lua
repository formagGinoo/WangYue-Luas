TaskBehavior105040201 = BaseClass("TaskBehavior105040201")
--第三章通用模板

function TaskBehavior105040201.GetGenerates()
	local generates = {}
	return generates
end

function TaskBehavior105040201:__init(taskInfo)
...
function TaskBehavior105040201:Update()
