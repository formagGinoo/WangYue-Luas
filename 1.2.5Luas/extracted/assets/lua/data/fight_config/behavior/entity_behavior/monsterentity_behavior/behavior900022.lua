Behavior900022 = BaseClass("Behavior900022",EntityBehaviorBase)
--资源预加载
function Behavior900022.GetGenerates()
	local generates = {}
	return generates
end
--mgaic预加载
function Behavior900022.GetMagics()
	local generates = {900000008,900000009}
	return generates
end
function Behavior900022:Init()
...
self.MonsterCommonBehavior = BehaviorFunctions.CreateBehavior("MonsterCommonBehavior",self)
	...
	--被暗杀动作
	self.beAssassin = 900022009
	self.backHited = 900022062
	...
	self.MonsterCommonParam.warnSkillId =  900022901        --警告技能Id
	self.MonsterCommonParam.tauntSkillId = 900022005         --嘲讽技能
...
--MonsterWander
	...
	self.MonsterCommonParam.defaultSkillId = 900022001		        --默认技能id，追杀模式使用
...
function Behavior900022:Update()
...
function Behavior900022:DeathEnter(instanceId,isFormationRevive)
...
function Behavior900022:Die(attackInstanceId,dieInstanceId)
