...
function AttrDebugPanel:UpdateItem(item, entity)
	...
	if item.entity.owner and item.entity.owner.instanceId ~= item.entity.instanceId then
		item.EntityIdText_txt.text = string.format("id: %d[%d]->%d", item.entity.instanceId, item.entity.entityId, item.entity.owner.instanceId)
	else
