...
local AnimatorNames = {
	...
	Drowning = "SwimDeath",
	StrideOver = "ClimbOver",
	StartClimb = "ClimbStart1",
	ClimbStart2 = "ClimbStart2",
	ClimbStart = "ClimbOver",
	Climbing = "Climbing",
	ClimbRun = "ClimbRun",
	ClimbRunEnd = "ClimbRunEnd",
	ClimbRunStart = "ClimbRunStart",
	ClimbIdle = "ClimbStand",
	ClimbingRunStart = "ClimbingRunStart",
	ClimbingRun = "ClimbingRunLoop",
	ClimbingRunEnd = "ClimbingRunEnd",
	ClimbRunOver = "ClimbRunOver",
	ClimbRunRightStart = "ClimbRunRightStart",
	ClimbRunRight = "ClimbRunRight",
	ClimbRunRightEnd = "ClimbRunRightEnd",
	ClimbRunLeftStart = "ClimbRunLeftStart",
	ClimbRunLeft = "ClimbRunLeft",
	ClimbRunLeftEnd = "ClimbRunLeftEnd",
	ClimbJumpLeft = "ClimbJumpLeft",
	ClimbJumpRight = "ClimbJumpRight",
	ClimbingJump = "ClimbingJump",
	ClimbJumpOver = "ClimbJumpOver",
	ClimbLand = "ClimbLand",
	ClimbJump = "ClimbJump",
	ClimbJumpStart = "ClimbStart1",
	GlideStart = "GlideStart",
	GlideLoopLeft = "GlideLeft",
	GlideLoopRight = "GlideRight",
	GlideLoop = "Gliding",
	GlideLoopFront = "GlideFront",
	HackStart = "PartnerCtrlStart",
	HackStand = "PartnerCtrlLoop",
	HackRun = "Run",
	HackEnd = "PartnerCtrlEnd",
	BuildStand = "PartnerCtrlLoop",
	BuildRun = "Run",
	GetInCar = "GetInCar",
	GetOffCar = "GetOffCar",
	Driving = "Driving",
...
EntityCommonConfig.JumpHurt = {
	CheckHeightHurt = 17.5,    -- 着地受伤高度
	PercentHeightHurt = 25,  -- 基础受伤百分比
	HeightHurtParam = 0.7,    -- 每0.1米掉落百分比
}
...
EntityCommonConfig.AimWeakMouseMoveParam = 0.38
...
EntityCommonConfig.AimTargetDistanceSpeed = 60

EntityCommonConfig.GlideDoubleJumpPressFrame = 6
EntityCommonConfig.GlideJumpPressFrame = 4
EntityCommonConfig.GlideStartDuration = 1.35