LevelBehavior3011501 = BaseClass("LevelBehavior3011501",LevelBehaviorBase)

function LevelBehavior3011501.GetGenerates()
	local generates = {900060,900140}
	return generates
end

function LevelBehavior3011501:__init(fight)
	self.fight = fight
end

function LevelBehavior3011501:Init()
	...
	self.monsterList =
	{
		{id = 900060 ,posName = "Mon0501" ,wave = 1,engage = false,patrolList = {"T50","T51"}},
		{id = 900060 ,posName = "Mon0502" ,wave = 1,engage = false,patrolList = nil},
		{id = 900060 ,posName = "Mon0503" ,wave = 1,engage = false,patrolList = nil},
		{id = 900060 ,posName = "Mon0504" ,wave = 2,patrolList = nil},
		{id = 900060 ,posName = "Mon0505" ,wave = 2,patrolList = nil},
	}
...
function LevelBehavior3011501:Update()
