TaskBehavior101260202 = BaseClass("TaskBehavior101260202")
--工地死亡保底

function TaskBehavior101260202.GetGenerates()
	local generates = {}
	return generates
end

function TaskBehavior101260202:__init(taskInfo)
...
function TaskBehavior101260202:Update()
	
	self.role = BehaviorFunctions.GetCtrlEntity()
	if self.inArea == false and BehaviorFunctions.CheckEntityInArea(self.role,"BuildingArea","Task_main_01") then
		local pos = BehaviorFunctions.GetTerrainPositionP("BuildRevivePos02",10020005,"Task_main_01")
...
function TaskBehavior101260202:Death(instanceId,isformation)
