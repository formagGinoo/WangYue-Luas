FSMBehavior9000 = BaseClass("FSMBehavior9000",FSMBehaviorBase)
--资源预加载
function FSMBehavior9000.GetGenerates()
	local generates = {}
	return generates
end
--mgaic预加载
function FSMBehavior9000.GetMagics()
	local generates = {900000008,900000009,900000024,900000025,900000107}
	return generates
end

function FSMBehavior9000:Init()
	...
	self.warnSkillId = 0				--警告技能Id
	self.warnSitSkillId = 0				--坐下后起立警告技能Id
	self.tauntSkillId = 0				--嘲讽技能
...
function FSMBehavior9000:LateInit()
...
function FSMBehavior9000:Update()
...
--检测暗杀目标移除
function FSMBehavior9000:RemoveBuff(entityInstanceId, buffInstanceId,buffId)
...
function FSMBehavior9000:BeforeDie(instanceId)
