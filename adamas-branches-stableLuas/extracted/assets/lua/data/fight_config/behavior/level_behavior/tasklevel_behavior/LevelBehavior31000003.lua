LevelBehavior31000003 = BaseClass("LevelBehavior31000003",LevelBehaviorBase)
--限时击杀怪物玩法
function LevelBehavior31000003:__init(fight)
	self.fight = fight
end


function LevelBehavior31000003.GetGenerates()
	local generates = {900040,910040,2030401}
	return generates
end


function LevelBehavior31000003:Init()
	...
	self.monsterList =
	{
		...
		[7] = {state = self.monsterStateEnum.Default,wave = 1,bp = "c3_Center",entityId = 910040},
	}
...
function LevelBehavior31000003:Update()
...
function LevelBehavior31000003:ChangeTarget(monsterList)
...
--清理战场
function LevelBehavior31000003:ResetBattle(monsterList)
	for i,v in ipairs(monsterList) do
		if v.state == self.monsterStateEnum.Live then
...
--召唤敌人
function LevelBehavior31000003:SummonMonster(monsterList,monsterNumLimit)
...
--击杀全部怪物挑战检查
function LevelBehavior31000003:ProtectChallenge(instanceId)
...
function LevelBehavior31000003:TimeLimitChallange(startTime,timeLimit,condiTion)
...
--额外时长奖励
function LevelBehavior31000003:BounsTime(bonusTime)
	self.bonusTime = self.bonusTime + bonusTime
end

--挑战开始
function LevelBehavior31000003:ChallengeStart(challangeName)
...
--挑战结束
function LevelBehavior31000003:ChallengeFinish(challangeName,isSuccese)
	if isSuccese then
...
function LevelBehavior31000003:Die(attackInstanceId,instanceId)
...
function LevelBehavior31000003:Death(instanceId,isFormationRevive)
	--角色死亡判负
...
--死亡事件
function LevelBehavior31000003:RemoveEntity(instanceId)

end


function LevelBehavior31000003:__delete()
