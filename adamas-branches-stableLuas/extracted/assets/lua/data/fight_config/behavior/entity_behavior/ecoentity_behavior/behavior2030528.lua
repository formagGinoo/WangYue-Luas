Behavior2030528 = BaseClass("Behavior2030528",EntityBehaviorBase)
...
--电压陷阱
function Behavior2030528.GetGenerates()
	 local generates = {}
	 return generates
end

function Behavior2030528:Init()
	self.me = self.instanceId
end


function Behavior2030528:LateInit()
...
function Behavior2030528:Update()

	
end

--点击下侧按钮,爆炸
function Behavior2030528:HackingClickDown(instanceId)
	if instanceId == self.me then
		BehaviorFunctions.SetEntityValue(self.me,"follow_200001180",true) --摧毁前清除周围敌人的寻路
		BehaviorFunctions.SetEntityValue(self.me,"level_200001181",2)
...
--点击右侧按钮,电磁场
function Behavior2030528:HackingClickRight(instanceId)
	if instanceId == self.me then
...
--点击左侧按钮，吸引敌人
function Behavior2030528:HackingClickLeft(instanceId)
	if instanceId == self.me then
