...
Config.Magic92002.Magics = 
{
  ...
  [ 100199000 ] = {
    ...
    Type = 16,
    Param = {
      CameraTrackPath = "Character/Monster/Baxilikesi/BaxilikesiMb1Low/Timeline/CtBaxilikesi@CtAttack101.prefab",
      TimeIn = 0.0,
      TimeOut = 0.8,
      UseTimeScale = false,
  ...
  [ 120100400 ] = {
    ...
    Type = 16,
    Param = {
      CameraTrackPath = "Character/Monster/Baxilikesi/BaxilikesiMb1Low/Camera/ATK201_camera.prefab",
      TimeIn = 0.0,
      TimeOut = 0.06,
      UseTimeScale = false,
      AutoResetVAxis = true,
