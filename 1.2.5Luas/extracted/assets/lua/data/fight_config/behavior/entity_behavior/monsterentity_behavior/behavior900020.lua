...
--function Behavior900020:WorldInteractClick(uniqueId)
...
--function Behavior900020:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	--if self.bronState == 1 then
		...
		--if not self.isTrigger then
			--return
		--end
		--self.interactUniqueId = BehaviorFunctions.WorldInteractActive(WorldEnum.InteractType.Collect,nil,"金矿",1)
	--end
--end
