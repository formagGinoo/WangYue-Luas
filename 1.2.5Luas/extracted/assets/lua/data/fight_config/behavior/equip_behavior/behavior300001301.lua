Behavior300001301 = BaseClass("Behavior300001301",EntityBehaviorBase)
function Behavior300001301.GetGenerates()


end

function Behavior300001301.GetMagics()
	local generates = {300001311}
	return generates
end

function Behavior300001301:Init()
	self.ecoEntitys = nil
	self.magicState = 0
...
function Behavior300001301:Update()
	self.time = BehaviorFunctions.GetEntityFrame(self.me)/30--时间

end

function Behavior300001301:Collide(attackInstanceId,hitInstanceId)
    if attackInstanceId == self.me 
		...
		if randomresult and randomresult<=30 then
			BehaviorFunctions.DoMagic(self.me,self.me,300001311,1)--火伤提升
