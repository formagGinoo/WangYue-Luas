Config = Config or {}
Config.Entity2040861 = Config.Entity2040861 or { }
local empty = { }
Config.Entity2040861 = 
{
  [ 2040861 ] = {
    EntityId = 2040861,
    Components = {
      Transform = {
        Prefab = "CommonEntity/Vehicle/MianBaoChe/Prefab/MianBaoChe00101.prefab",
        Model = "MianBaoChe00101",
        isClone = true,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                ParentName = "Collider",
                LocalPosition = { 0.0, 1.021, 0.043 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 2.17350841, 1.65161943, 4.90826273 },
      ...
      Animator = {
        Animator = "CommonEntity/Vehicle/MianBaoChe/Animation/MianBaoChe001/MianBaoChe001.controller",
        AnimationConfigID = "",
