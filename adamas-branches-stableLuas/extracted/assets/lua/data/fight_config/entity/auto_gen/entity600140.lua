Config = Config or {}
Config.Entity600140 = Config.Entity600140 or { }
local empty = { }
Config.Entity600140 = 
{
  [ 600140 ] = {
    ...
    Components = {
      ...
      Animator = {
        Animator = "Character/Monster/Elaizumale/ElaizumaleMo1/ElaizumaleMo1P.controller",
        AnimationConfigID = "",
        TransitionDic = {
          [ 0 ] = {
            AnyState = {
            ...
            BoneColliders = {
              {
                ...
                LocalPosition = { 0.39, 0.111, -0.022 },
                LocalEuler = { 281.357727, 286.7412, 166.4456 },
                LocalScale = { 1.0, 0.84030664, 1.0 }
              }
            },
            LogicSearch = true,
            SearchWeight = 0.0,
