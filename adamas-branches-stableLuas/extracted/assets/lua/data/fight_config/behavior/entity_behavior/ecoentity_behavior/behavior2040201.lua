...
function Behavior2040201:WorldInteractClick(uniqueId, instanceId)
...
function Behavior2040201:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)--进入交互范围
	...
	elseif not self.hidetigger then--没有隐藏按钮
		self.interactUniqueId = BehaviorFunctions.WorldInteractActive(self.me,WorldEnum.InteractType.Item,200001,"开始挑战", 1)--物品类型，图标，文字，品质
	    --LogError("ssssssssss")
	end
end
