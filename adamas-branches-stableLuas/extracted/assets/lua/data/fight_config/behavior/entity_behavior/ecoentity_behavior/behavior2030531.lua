Behavior2030531 = BaseClass("Behavior2030531",EntityBehaviorBase)
...
--电压陷阱
function Behavior2030531.GetGenerates()
	 local generates = {}
	 return generates
end

function Behavior2030531:Init()
	self.me = self.instanceId
end


function Behavior2030531:LateInit()
...
function Behavior2030531:Update()

	
end

--点击下侧按钮,爆炸
function Behavior2030531:HackingClickDown(instanceId)
...
--点击右侧按钮,电磁场
function Behavior2030531:HackingClickRight(instanceId)
	if instanceId == self.me then
...
--点击左侧按钮，吸引敌人
function Behavior2030531:HackingClickLeft(instanceId)
	if instanceId == self.me then
