Config = Config or {}
Config.Entity800100201 = Config.Entity800100201 or { }
local empty = { }
Config.Entity800100201 = 
{
  [ 800100201 ] = {
    EntityId = 800100201,
    EntityName = "800100201",
    Components = {
      Transform = {
        Prefab = "Character/Role/Female165/KekeR31/KekeR31M11/KekeR31M11.prefab",
        isClone = false,
        StartRotateType = 0,
        StartRotateX = 0.0,
        RandomMinX = 0.0,
      ...
      Animator = {
        Animator = "Character/Role/Female165/KekeR31/KekeR31M11/KekeR31M11.controller",
