LevelBehavior104020301 = BaseClass("LevelBehavior104020301",LevelBehaviorBase)
--版署主线第三章通用关卡逻辑

function LevelBehavior104020301:__init(fight)
	self.fight = fight
end

function LevelBehavior104020301.GetGenerates()
	local generates = {
        900040,   --木从士
        900041,   --火从士
        900042,   --冰从士
...
function LevelBehavior104020301:Init()
	self.missionState = 0
    self.role = nil
    self.posName = "Diaochadian01"
	self.deathCount = 0
	self.monsterList = {
        900040,900030,900050
    }
end

function LevelBehavior104020301:Update()
	self.role = BehaviorFunctions.GetCtrlEntity()
    self:CreateMonster()
end

function LevelBehavior104020301:__delete()

end

--在某个点附近创建怪
function LevelBehavior104020301:CreateMonster()
...
--死亡事件
function LevelBehavior104020301:Death(instanceId,isFormationRevive)
...
function LevelBehavior104020301:LevelFinish()
