LevelBehavior104020501 = BaseClass("LevelBehavior104020501",LevelBehaviorBase)
--版署主线第三章通用关卡逻辑

function LevelBehavior104020501:__init(fight)
	self.fight = fight
end

function LevelBehavior104020501.GetGenerates()
	local generates = {
        900040,   --木从士
        900041,   --火从士
        900042,   --冰从士
...
function LevelBehavior104020501:Init()
	self.missionState = 0
    self.role = nil
    self.posName = "Diaochadian02"
	self.deathCount = 0
	self.monsterList = {
...
function LevelBehavior104020501:Update()
	self.role = BehaviorFunctions.GetCtrlEntity()
    self:CreateMonster()
end

function LevelBehavior104020501:__delete()

end

--在某个点附近创建怪
function LevelBehavior104020501:CreateMonster()
...
--死亡事件
function LevelBehavior104020501:Death(instanceId,isFormationRevive)
...
function LevelBehavior104020501:LevelFinish()
