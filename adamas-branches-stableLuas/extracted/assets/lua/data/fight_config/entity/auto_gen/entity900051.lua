Config = Config or {}
Config.Entity900051 = Config.Entity900051 or { }
local empty = { }
Config.Entity900051 = 
{
  [ 90005102001 ] = {
    EntityId = 90005102001,
    Components = {
      Transform = {
        Prefab = "Character/Monster/Congshigong/CongshigongMo2/Effect/FxCongshigongMo2Atk002M.prefab",
        Model = "FxCongshigongMo2Atk002M",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
      ...
      Attack = {
        ...
        SoundsByTarget = {
          "CongshigongMo2_Missile_Hit"
        },
        WwisePTRC = {
          paramName = "CongshigongMo2_Missile_Hit",
          value = 100.0,
          time = 0.0
        },        CreateHitEntities = {
          {
      ...
      Sound = {
        SoundEventList = {
          {
            EventType = 1,
            SoundEvent = "CongshigongMo2_Missile",
            DelayTime = 0.0,
            LifeBindEntity = true
          }
        },
  ...
  [ 90005103002 ] = {
    EntityId = 90005103002,
    Components = {
      Transform = {
        Prefab = "Character/Monster/Congshigong/CongshigongMo2/Effect/FxCongshigongMo2Atk003M.prefab",
        Model = "FxCongshigongMo2Atk003M",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 9000510201 ] = {
    ...
    Components = {
      Effect = {
        IsHang = true,
        IsBind = true,
        BindTransformName = "CongshigongMo2",
        IsBindWeapon = false,
      ...
      Transform = {
        Prefab = "Character/Monster/Congshigong/CongshigongMo2/Effect/FxCongshigongMo2Atk002.prefab",
        Model = "FxCongshigongMo2Atk002",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 9000510302 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "Character/Monster/Congshigong/CongshigongMo2/Effect/FxCongshigongMo2Atk003WpCaseLeft.prefab",
        Model = "FxCongshigongMo2Atk003WpCaseLeft",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 9000510202 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "Character/Monster/Congshigong/CongshigongMo2/Effect/FxCongshigongMo2Atk002WpCaseLeft.prefab",
        Model = "FxCongshigongMo2Atk002WpCaseLeft",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 9000510203 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "Character/Monster/Congshigong/CongshigongMo2/Effect/FxCongshigongMo2Atk002H.prefab",
        Model = "FxCongshigongMo2Atk002H",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 9000510301 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "Character/Monster/Congshigong/CongshigongMo2/Effect/FxCongshigongMo2Atk003.prefab",
        Model = "FxCongshigongMo2Atk003",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
  ...
  [ 900051 ] = {
    ...
    Components = {
      Transform = {
        Prefab = "Character/Monster/Congshigong/CongshigongMo2/CongshigongMo2.prefab",
        Model = "CongshigongMo2",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
      ...
      Animator = {
        Animator = "Character/Monster/Congshigong/CongshigongMo2/CongshigongMo2.controller",
        AnimationConfigID = "",
        TransitionDic = {
          [ 0 ] = {
            AnyState = {
            ...
            BoneColliders = {
              {
                ShapeType = 3,
                ParentName = "Bip001",
                LocalPosition = { -0.05473239, 0.0017447772, -0.489438653 },
              ...
              [ 0 ] = {
                {
                  ...
                  EventName = "CongshigongMo2_Atk002",
                  LifeBindSkill = true,
                  StopDelayFrame = 4,
                  StopFadeDuration = 4,
                  FrameTime = 0,
              ...
              [ 0 ] = {
                {
                  ...
                  EventName = "CongshigongMo2_Atk003",
                  LifeBindSkill = true,
                  StopDelayFrame = 4,
                  StopFadeDuration = 4,
                  FrameTime = 0,
