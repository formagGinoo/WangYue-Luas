...
--点击交互:播放默认对话
function FSMBehavior800004:WorldInteractClick(uniqueId)
...
--进入交互范围，添加交互列表
function FSMBehavior800004:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
--退出交互范围，移除交互列表
function FSMBehavior800004:ExitTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
--对话结束
function FSMBehavior800004:StoryEndEvent(dialogId)
...
--巡逻
function FSMBehavior800004:Patrol()
...
function FSMBehavior800004:PathFindingBegin()
	local nextPosition = BehaviorFunctions.GetTerrainPositionP(self.patrolList[self.patrolNum].posName,10020001,self.logicName)
...
function FSMBehavior800004:PathFindingEnd(instanceId,result)
...
function FSMBehavior800004:NextPatrolNum()
	--获取下一个目标点
	--不会折返
...
--受击
function FSMBehavior800004:FirstCollide(attackInstanceId,hitInstanceId,instanceId)
...
--移动碰撞
function FSMBehavior800004:OnEntityCollision(instanceId,collisionInstanceId)
...
--移动碰撞条件
function FSMBehavior800004:BeCollideRule()
...
--位移转身
function FSMBehavior800004:Turn(pos,lookPos)
...
--默认动作轮播
function FSMBehavior800004:DefaultAct()
...
--对话动作轮播
function FSMBehavior800004:TalkAct()
...
--气泡对话
function FSMBehavior800004:Bubble()
	--设置气泡对话内容
...
--注视IK
function FSMBehavior800004:CanLook(Can)

end

--解析patrolList
function FSMBehavior800004:GetPatrolList(list)
...
--解析AniList
function FSMBehavior800004:GetAniList(list)
	local beforeList = list
	local afterList = {}
	for i = 1, #beforeList do
		local stepList = self:SplitParam(beforeList[i],"-")
...
--拆分字符串
function FSMBehavior800004:SplitParam(string,sep)
	local list = {}
	if string == nil then
		return nil
	end
...
--赋值
function FSMBehavior800004:Assignment(variable,value)
	self[variable] = value
