LevelBehavior200509006 = BaseClass("LevelBehavior200509006",LevelBehaviorBase)
--关卡测试关
function LevelBehavior200509006:__init(fight)
	self.fight = fight
end


function LevelBehavior200509006.GetGenerates()
...
function LevelBehavior200509006.GetMagics()
	local generates = {200000017}
	return generates
end

function LevelBehavior200509006:Init()
	--通用参数---------------------------------------------------------------------------------------------------------------------
	...
	self.ecoMe = 2003001092061 --自己生态id
	...
	self.npc = {
		[1] = {id = nil, pos = nil, rot = nil, entity = 8011001, isEnemy = false,ecoId = 5003001092061,ecoPos = "npc1"},
		[2] = {id = nil, pos = nil, rot = nil, entity = 8011002, isEnemy = false,ecoId = 5003001092062,ecoPos = "npc2"},
		[3] = {id = nil, pos = nil, rot = nil, entity = 8011003, isEnemy = false,ecoId = 5003001092063,ecoPos = "npc3"},
		[4] = {id = nil, pos = nil, rot = nil, entity = 8010004, isEnemy = false, ecoId = 5003001092064,ecoPos = "npc5"},
		[5] = {id = nil, pos = nil, rot = nil, entity = 8010004, isEnemy = true,ecoId = 5003001092065,ecoPos = "npc6"},
...
function LevelBehavior200509006:Update()
...
function LevelBehavior200509006:Die(attackInstanceId,dieInstanceId)
...
----死亡
--function LevelBehavior200509006:Death(instanceId,isFormationRevive)
...
--与NPC互动
function LevelBehavior200509006:WorldInteractClick(uniqueId,instanceId)
...
--对话开始
function LevelBehavior200509006:StoryStartEvent(dialogId)
...
--对话结束
function LevelBehavior200509006:StoryEndEvent(dialogId)
	if self.state == 0 then
		if dialogId == self.battleDialog then
...
--播放特定对话
function LevelBehavior200509006:StoryPassEvent(dialogId)
	if self.state == 0 then
		--如果播放警察的请求对话
...
--拦截短信
function LevelBehavior200509006:HackingClickUp(instanceId)
	if instanceId == self.monster.id then
...
--输入按键
function LevelBehavior200509006:KeyInput(key, status)
...
--检查npc生成状态
function LevelBehavior200509006:CheckNPC(npcList)
	if self.monster.id then
...
--播放动作
function LevelBehavior200509006:PlayAnimationHuishou(instanceId,ani,Loop,aniFrameCD,aniInFrameCD,aniLoopFrameCD,aniEndFrameCD)
...
function LevelBehavior200509006:OnAttackNpc(attackInstanceId,hitInstanceId,instanceId,attackType, skillType)
