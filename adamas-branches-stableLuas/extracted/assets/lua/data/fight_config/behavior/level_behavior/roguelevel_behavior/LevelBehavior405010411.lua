LevelBehavior405010411 = BaseClass("LevelBehavior405010411",EntityBehaviorBase)
--摄像头玩法关卡1
function LevelBehavior405010411:__init(fight)
	self.fight = fight
end

function LevelBehavior405010411.GetGenerates()
...
function LevelBehavior405010411:Init()
	...
	self.levelId = 405010411 -- 这个是关卡ID
	self.positionLevel = 10020005 -- 这个才是找地图点位信息的levelId
	self.npc = "npc011" --创建的npc的position名字
	self.door = "Door011" --创建的门的position名字
	self.door2 = "Door012" --创建的门的position名字
	
	self.cameraList = {
		[1] = {bp = "Camera011", Id = nil , entityId = 2030504}, --室内1
		[2] = {bp = "Camera012", Id = nil , entityId = 2030504}, --室内2
		[3] = {bp = "Camera013", Id = nil , entityId = 2030504}, --室内3
		[4] = {bp = "Camera014", Id = nil , entityId = 2030529}, --室外1
		[5] = {bp = "Camera015", Id = nil , entityId = 2030504}, --室内4
		[6] = {bp = "Camera016", Id = nil , entityId = 2030504}, --室内4
	}
	
	
	self.monsterList = {
		[1] = {bp = "Luohou011", Id = nil , entityId = 900070}, --小怪1
		[2] = {bp = "Luohou012", Id = nil , entityId = 8010005}, --小怪2
		[3] = {bp = "Luohou013", Id = nil , entityId = 900070}, --小怪3
		[4] = {bp = "Luohou014", Id = nil , entityId = 900070}, --小怪4
	}
	
	
	self.missionList = {
		[1] = {bp = "Computer011", Id = nil , entityId = 2030513}, --任务道具1
		[2] = {bp = "Computer012", Id = nil , entityId = 2030513}, --任务道具2
		[3] = {bp = "Audio011", Id = nil , entityId = 2030514}, --任务道具3
	}
...
function LevelBehavior405010411:LateInit()
	
	
end

function LevelBehavior405010411:Update()
...
--肉鸽追踪
function LevelBehavior405010411:RogueGuidePointer(guidePos,guideDistance,guideType)
...
--进入实体范围
function LevelBehavior405010411:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
--退出实体范围
function LevelBehavior405010411:ExitTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	if roleInstanceId == self.role then
		if triggerInstanceId == self.levelFlag then
...
--实体按钮交互
function LevelBehavior405010411:WorldInteractClick(uniqueId,instanceId)
...
--检查电脑有没有被看管
function LevelBehavior405010411:ComputerByGuard(computerId,guardId,watchangle)
...
--给电脑上锁
function LevelBehavior405010411:LockComputer(computerId)
...
function LevelBehavior405010411:StoryPassEvent(dialogId)
...
function LevelBehavior405010411:StoryEndEvent(dialogId)
	--结束罗睺的警告动画之后
...
--function LevelBehavior405010411:Death(instanceId,isFormationRevive)
...
----重置关卡
--function LevelBehavior405010411:Remark()
--end

--点击骇入按钮的上键
function LevelBehavior405010411:HackingClickUp(instanceId)
