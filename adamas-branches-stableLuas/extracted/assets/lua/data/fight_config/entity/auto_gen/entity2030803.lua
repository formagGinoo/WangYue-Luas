Config = Config or {}
Config.Entity2030803 = Config.Entity2030803 or { }
local empty = { }
Config.Entity2030803 = 
{
  [ 2030803 ] = {
    EntityId = 2030803,
    Components = {
      Transform = {
        Prefab = "CommonEntity/FireDevice/Prefab/FireDevice01.prefab",
        Model = "FireDevice01",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
  ...
  [ 203080302 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "CommonEntity/FireDevice/Effect/Fx_FireDevice.prefab",
        Model = "Fx_FireDevice",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
