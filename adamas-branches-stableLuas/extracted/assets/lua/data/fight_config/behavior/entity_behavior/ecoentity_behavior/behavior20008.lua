Behavior20008 = BaseClass("Behavior20008",EntityBehaviorBase)
--竞速挑战
function Behavior20008.GetGenerates()
	local generates = {900040,910040}
	return generates
end

function Behavior20008:Init()
...
function Behavior20008:WorldInteractClick(uniqueId, instanceId)
...
function Behavior20008:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
function Behavior20008:ExitTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	if self.showSelf then
...
--清理战场
function Behavior20008:ResetBattle(monsterList)
...
--召唤敌人
function Behavior20008:SummonMonster(monsterList,monsterNumLimit)
...
--击杀全部怪物挑战检查
function Behavior20008:KillAllMonsterChallenge(monsterList)
	for i,v in ipairs(monsterList) do
...
function Behavior20008:TimeLimitChallange(startTime,timeLimit,condiTion,showTimeRemain)
...
--额外时长奖励
function Behavior20008:BounsTime(bonusTime)
	self.bonusTime = self.bonusTime + bonusTime
end

--挑战开始
function Behavior20008:ChallengeStart(challangeName)
	--开始挑战
...
--挑战结束
function Behavior20008:ChallengeFinish(challangeName,isSuccese)
	BehaviorFunctions.HideTip()
	self.showSelf = true
	if isSuccese then
...
function Behavior20008:Die(attackInstanceId,instanceId)
...
function Behavior20008:Death(instanceId,isFormationRevive)
	--角色死亡判负
...
function Behavior20008:BeDodge(attackInstanceId,hitInstanceId,limit)
