LevelBehavior10011006 = BaseClass("LevelBehavior10011006",LevelBehaviorBase)
--肉鸽测试关卡:浮空岛基础战斗01
function LevelBehavior10011006:__init(fight)
	self.fight = fight
end


function LevelBehavior10011006.GetGenerates()
	local generates = {900040,910040,2030502,203051113,20305080002,20305023,20305080101,203050804,900070,900071}
	return generates
end


function LevelBehavior10011006:Init()
...
-----关卡配置参数---------------------------------------------------------------------------------------------------------------------------------------
	...
	self.monsterList =
	{
		...
		[3] = {state = self.monsterStateEnum.Default,wave = 2,entityId = 900040},
	}
	...
	self.gravityList =
	{
		[1] = {state = self.monsterStateEnum.Default,wave =1,distance = 0,pos=0,radius = 30,inRadius = false,round = false, roundDeep = 3},
	}
...
function LevelBehavior10011006:LateInit()
	----设置任务开始位置
...
function LevelBehavior10011006:Update()
...
--检查玩家角色是否处于关卡范围内
function LevelBehavior10011006:CheckPlayerInRange(distance)
...
--肉鸽追踪
function LevelBehavior10011006:RogueGuidePointer(guidePos,guideDistance,guideType)
	local playerPos = BehaviorFunctions.GetPositionP(self.role)
...
--进入实体范围
function LevelBehavior10011006:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
--退出实体范围
function LevelBehavior10011006:ExitTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	if roleInstanceId == self.role then
		if triggerInstanceId == self.levelFlag then
...
--实体按钮交互
function LevelBehavior10011006:WorldInteractClick(uniqueId,instanceId)
...
--召唤敌人
function LevelBehavior10011006:SummonMonster(monsterList,monsterDotList,monsterNumLimit)
...
--召唤重力装置
function LevelBehavior10011006:SummonGravity(gravityList,gravityDotList)
...
--解决全部敌人
function LevelBehavior10011006:KillAllMonsterChallenge(monsterList,gravityList)
	for i,v in ipairs(monsterList) do
...
function LevelBehavior10011006:Die(attackInstanceId,instanceId)
	--怪物死亡计数
...
function LevelBehavior10011006:Death(instanceId,isFormationRevive)
	--角色死亡判负
...
--检查坐标点是否处于画面中
function LevelBehavior10011006:CheckPosInCam(Position)
...
function LevelBehavior10011006:OnSwitchPlayerCtrl(oldInstanceId, instanceId)
