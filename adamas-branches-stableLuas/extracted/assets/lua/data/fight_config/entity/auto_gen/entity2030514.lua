Config = Config or {}
Config.Entity2030514 = Config.Entity2030514 or { }
local empty = { }
Config.Entity2030514 = 
{
  [ 2030514 ] = {
    EntityId = 2030514,
    Components = {
      ...
      HackingInputHandle = {
        ...
        UpHackingClickType = {
          ...
          HackingButtonName = "激活",
          CostElectricity = 0,
          HackingRam = 0,
          HackingDesc = "吸引特定目标靠近"
        },
        UpHackingActiveType = {
          CostElectricity = 0,
        ...
        PartList = {
          {
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                LocalPosition = { 0.06, 1.26, 0.053 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 1.67885351, 3.12103057, 1.7338 }
              }
            },
            DefaultEnable = true,
            ColliderFollow = 1,
