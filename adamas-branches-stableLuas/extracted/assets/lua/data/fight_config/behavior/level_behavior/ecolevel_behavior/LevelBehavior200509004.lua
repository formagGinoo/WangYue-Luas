LevelBehavior200509004 = BaseClass("LevelBehavior200509004",LevelBehaviorBase)
--关卡测试关
function LevelBehavior200509004:__init(fight)
	self.fight = fight
end


function LevelBehavior200509004.GetGenerates()
...
function LevelBehavior200509004.GetMagics()
	local generates = {200000017}
	return generates
end

function LevelBehavior200509004:Init()
	--通用参数---------------------------------------------------------------------------------------------------------------------
	...
	self.ecoMe = 2003001092041 --自己生态id
	self.police = {id = nil, pos = nil,ecoId = nil, ecoPos = "police" , entity = 8011011,bubble1 = "觉醒者，帮帮忙！", bubble2 = "如果能骇入的话..."} --警察参数
	--怪物参数，只需要填怪物实体id即可
	self.monster = {id = nil, pos = nil, rot = nil, entity = 790014000, npcEntity = nil, ecoId = nil,ecoPos = "mon1", henshin = false} --怪物参数
	self.npc = {
		[1] = {id = nil, pos = nil, rot = nil, entity = 8011001, isEnemy = false,ecoId = 5003001092041,ecoPos = "npc1"},
		[2] = {id = nil, pos = nil, rot = nil, entity = 8011002, isEnemy = false,ecoId = 5003001092042,ecoPos = "npc2"},
		[3] = {id = nil, pos = nil, rot = nil, entity = 8011003, isEnemy = false,ecoId = 5003001092043,ecoPos = "npc3"},
		[4] = {id = nil, pos = nil, rot = nil, entity = 8010004, isEnemy = false, ecoId = 5003001092045,ecoPos = "npc5"},
		[5] = {id = nil, pos = nil, rot = nil, entity = 8010004, isEnemy = true,ecoId = 5003001092046,ecoPos = "npc6"},
...
function LevelBehavior200509004:Update()
...
function LevelBehavior200509004:Die(attackInstanceId,dieInstanceId)
...
----死亡
--function LevelBehavior200509004:Death(instanceId,isFormationRevive)
...
--与NPC互动
function LevelBehavior200509004:WorldInteractClick(uniqueId,instanceId)
...
--对话开始
function LevelBehavior200509004:StoryStartEvent(dialogId)
	--开始战斗的对话
...
--对话结束
function LevelBehavior200509004:StoryEndEvent(dialogId)
	if dialogId == self.battleDialog then
...
--播放特定对话
function LevelBehavior200509004:StoryPassEvent(dialogId)
	--如果播放警察的请求对话
...
--拦截短信
function LevelBehavior200509004:HackingClickUp(instanceId)
	if instanceId == self.monster.id then
...
--输入按键
function LevelBehavior200509004:KeyInput(key, status)
...
--检查npc生成状态
function LevelBehavior200509004:CheckNPC(npcList)
	if self.monster.id then
...
--播放动作
function LevelBehavior200509004:PlayAnimationHuishou(instanceId,ani,Loop,aniFrameCD,aniInFrameCD,aniLoopFrameCD,aniEndFrameCD)
...
function LevelBehavior200509004:OnAttackNpc(attackInstanceId,hitInstanceId,instanceId,attackType, skillType)
