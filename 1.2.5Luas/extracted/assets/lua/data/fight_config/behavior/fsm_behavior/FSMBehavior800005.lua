...
--点击交互:播放默认对话
function FSMBehavior800005:WorldInteractClick(uniqueId)
...
--进入交互范围，添加交互列表
function FSMBehavior800005:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
--退出交互范围，移除交互列表
function FSMBehavior800005:ExitTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
--对话结束
function FSMBehavior800005:StoryEndEvent(dialogId)
...
--巡逻
function FSMBehavior800005:Patrol()
...
function FSMBehavior800005:PathFindingBegin()
	local nextPosition = BehaviorFunctions.GetTerrainPositionP(self.patrolList[self.patrolNum].posName,10020001,self.logicName)
...
function FSMBehavior800005:PathFindingEnd(instanceId,result)
...
function FSMBehavior800005:NextPatrolNum()
	--获取下一个目标点
	--不会折返
...
--受击
function FSMBehavior800005:FirstCollide(attackInstanceId,hitInstanceId,instanceId)
...
--移动碰撞
function FSMBehavior800005:OnEntityCollision(instanceId,collisionInstanceId)
...
--移动碰撞条件
function FSMBehavior800005:BeCollideRule()
...
--位移转身
function FSMBehavior800005:Turn(pos,lookPos)
...
--默认动作轮播
function FSMBehavior800005:DefaultAct()
...
--对话动作轮播
function FSMBehavior800005:TalkAct()
...
--气泡对话
function FSMBehavior800005:Bubble()
	--设置气泡对话内容
...
--注视IK
function FSMBehavior800005:CanLook(Can)

end

--解析patrolList
function FSMBehavior800005:GetPatrolList(list)
...
--解析AniList
function FSMBehavior800005:GetAniList(list)
	local beforeList = list
	local afterList = {}
	for i = 1, #beforeList do
		local stepList = self:SplitParam(beforeList[i],"-")
...
--拆分字符串
function FSMBehavior800005:SplitParam(string,sep)
	local list = {}
	if string == nil then
		return nil
	end
...
--赋值
function FSMBehavior800005:Assignment(variable,value)
	self[variable] = value
