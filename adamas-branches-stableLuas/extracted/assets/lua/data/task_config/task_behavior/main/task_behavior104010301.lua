TaskBehavior104010301 = BaseClass("TaskBehavior104010301")
--第三章通用模板

function TaskBehavior104010301.GetGenerates()
	local generates = {}
	return generates
end

function TaskBehavior104010301:__init(taskInfo)
...
function TaskBehavior104010301:Update()
