LevelBehavior405010412 = BaseClass("LevelBehavior405010412",EntityBehaviorBase)
--摄像头玩法关卡1
function LevelBehavior405010412:__init(fight)
	self.fight = fight
end

function LevelBehavior405010412.GetGenerates()
...
function LevelBehavior405010412:Init()
	...
	self.levelId = 405010412 -- 这个是关卡ID
	self.positionLevel = 10020005 -- 这个才是找地图点位信息的levelId
	self.npc = "npc021" --创建的npc的position名字
	self.door = "Door021" --创建的门的position名字
	self.door2 = "Door022" --创建的门的position名字
	
	self.cameraList = {
		[1] = {bp = "Camera021", Id = nil , entityId = 2030504}, --室内1
		[2] = {bp = "Camera022", Id = nil , entityId = 2030504}, --室内2
		[3] = {bp = "Camera023", Id = nil , entityId = 2030504}, --室内3
		[4] = {bp = "Camera024", Id = nil , entityId = 2030529}, --室外1
		[5] = {bp = "Camera025", Id = nil , entityId = 2030504}, --室内4
		[6] = {bp = "Camera026", Id = nil , entityId = 2030504}, --室内4
	}
	
	
	self.monsterList = {
		[1] = {bp = "Luohou021", Id = nil , entityId = 900070}, --小怪1
		[2] = {bp = "Luohou022", Id = nil , entityId = 8010005}, --小怪2
		[3] = {bp = "Luohou023", Id = nil , entityId = 900070}, --小怪3
		[4] = {bp = "Luohou024", Id = nil , entityId = 900070}, --小怪4
	}
	
	
	self.missionList = {
		[1] = {bp = "Computer021", Id = nil , entityId = 2030513}, --任务道具1
		[2] = {bp = "Computer022", Id = nil , entityId = 2030513}, --任务道具2
		[3] = {bp = "Audio021", Id = nil , entityId = 2030514}, --任务道具3
		[4] = {bp = "Computer023", Id = nil , entityId = 2030513}, --任务道具3
	}
...
function LevelBehavior405010412:LateInit()
	
	
end

function LevelBehavior405010412:Update()
	...
	elseif self.levelState == self.levelStateEnum.Start then
		...
		self.computer3 = self.missionList[4].Id --第三个电脑
...
--肉鸽追踪
function LevelBehavior405010412:RogueGuidePointer(guidePos,guideDistance,guideType)
...
--进入实体范围
function LevelBehavior405010412:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
--退出实体范围
function LevelBehavior405010412:ExitTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	if roleInstanceId == self.role then
		if triggerInstanceId == self.levelFlag then
...
--实体按钮交互
function LevelBehavior405010412:WorldInteractClick(uniqueId,instanceId)
...
--检查电脑有没有被看管
function LevelBehavior405010412:ComputerByGuard(computerId,guardId,watchangle)
...
--给电脑上锁
function LevelBehavior405010412:LockComputer(computerId)
...
function LevelBehavior405010412:StoryPassEvent(dialogId)
...
function LevelBehavior405010412:StoryEndEvent(dialogId)
	--结束罗睺的警告动画之后
...
--function LevelBehavior405010412:Death(instanceId,isFormationRevive)
...
----重置关卡
--function LevelBehavior405010412:Remark()
--end

--点击骇入按钮的上键
function LevelBehavior405010412:HackingClickUp(instanceId)
	...
	if instanceId == self.cameraList[4].Id then
		...
		BehaviorFunctions.ChangeTitleTipsDesc(20305135,self.goalNum,self.successNum)
