TaskBehavior104030401 = BaseClass("TaskBehavior104030401")
--第三章通用模板

function TaskBehavior104030401.GetGenerates()
	local generates = {}
	return generates
end

function TaskBehavior104030401:__init(taskInfo)
...
function TaskBehavior104030401:Update()
