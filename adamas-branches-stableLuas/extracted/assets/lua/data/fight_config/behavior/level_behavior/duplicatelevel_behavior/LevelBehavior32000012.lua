LevelBehavior32000012 = BaseClass("LevelBehavior32000012",LevelBehaviorBase)
--梦魇初3-1


function LevelBehavior32000012.GetGenerates()
	local generates = {2000,790012000,790013000,791004000,70920011}
	return generates
end

function LevelBehavior32000012:__init(fight)
	self.fight = fight
end


function LevelBehavior32000012:Init()
	...
	self.monsterList =
	{
		[1] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 1 ,lev = 44 ,entityId = 791004000},  --1精英从士
		[2] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 1 ,lev = 44 ,entityId = 791004000},  --1精英从士
		[3] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon3" ,wave = 1 ,lev = 44 ,entityId = 790013000},  --1从士射手
		[4] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon4" ,wave = 1 ,lev = 44 ,entityId = 790013000},  --1从士射手
		[5] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon6" ,wave = 1 ,lev = 44 ,entityId = 790012000},  --1从士
		[6] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon3" ,wave = 2 ,lev = 44 ,entityId = 70920011},  --2离歌
	}
...
function LevelBehavior32000012:Update()
	...
	if self.missionState == 0 then
		...
		local fp1 = BehaviorFunctions.GetTerrainPositionP("mon2",32000012)
...
function LevelBehavior32000012:CreatMonster(wave)
...
function LevelBehavior32000012:Death(instanceId,isFormationRevive)
	--计算怪物全部死亡
	for i,v in ipairs(self.monsterList) do
		--计算当前波次怪物死亡数
...
--BehaviorFunctions.ShowTip(32000012)
--end
...
function LevelBehavior32000012:__delete()
