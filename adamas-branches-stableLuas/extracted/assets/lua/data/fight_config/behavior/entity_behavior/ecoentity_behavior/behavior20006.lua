...
function Behavior20006:WorldInteractClick(uniqueId, instanceId)
...
function Behavior20006:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	if self.isActive == false then
		...
		self.interactUniqueId = BehaviorFunctions.WorldInteractActive(self.me,WorldEnum.InteractType.Item,200001,"激活", 1)
	end
end
