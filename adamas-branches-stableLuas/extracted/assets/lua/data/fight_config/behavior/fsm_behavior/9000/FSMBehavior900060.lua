FSMBehavior900060 = BaseClass("FSMBehavior900060",FSMBehaviorBase)
--资源预加载
function FSMBehavior900060.GetGenerates()
	local generates = {}
	return generates
end
--mgaic预加载
function FSMBehavior900060.GetMagics()
	--local generates = {900000024,900000025,900000107}
	return generates
end

function FSMBehavior900060:Init()
	...
	self.warnVisionAngle = 180          --远距离警告视角
	self.warnLimitHeight = 2          --极限警告高度
	self.warnDelayTime = 2            --警告延迟时间
	self.warnSkillId = 900060010            --警告技能Id
	self.warnSitSkillId = 900060010         --坐下后起立警告技能Id
	self.tauntSkillId = 900060001           --嘲讽技能
...
function FSMBehavior900060:LateInit()
...
function FSMBehavior900060:Update()
...
function FSMBehavior900060:DeathEnter(instanceId,isFormationRevive)
...
function FSMBehavior900060:Die(attackInstanceId,dieInstanceId)
...
--检测暗杀目标移除
function FSMBehavior900060:RemoveBuff(entityInstanceId, buffInstanceId,buffId)
...
function FSMBehavior900060:BeforeDie(instanceId)
	if instanceId == self.me then
