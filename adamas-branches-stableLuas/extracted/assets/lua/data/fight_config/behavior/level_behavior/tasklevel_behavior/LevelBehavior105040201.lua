LevelBehavior105040201 = BaseClass("LevelBehavior105040201",LevelBehaviorBase)
--版署主线第三章通用关卡逻辑

function LevelBehavior105040201:__init(fight)
	self.fight = fight
end

function LevelBehavior105040201.GetGenerates()
	local generates = {900070, 900080}
	return generates
end

function LevelBehavior105040201:Init()
	self.missionState = 0
    self.role = nil
...
function LevelBehavior105040201:Update()
	self.role = BehaviorFunctions.GetCtrlEntity()
    self:CreateMonster()
end

function LevelBehavior105040201:__delete()

end

--在某个点附近创建怪
function LevelBehavior105040201:CreateMonster()
...
--死亡事件
function LevelBehavior105040201:Death(instanceId,isFormationRevive)
...
function LevelBehavior105040201:LevelFinish()
