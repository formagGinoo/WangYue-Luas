LevelBehavior31003 = BaseClass("LevelBehavior31003",LevelBehaviorBase)
--动态创建关卡1
function LevelBehavior31003:__init(fight)
	self.fight = fight
end


function LevelBehavior31003.GetGenerates()
...
function LevelBehavior31003:Init()
	self.role = 1
	self.missionState = 0
	self.monster1 = 0
	self.monster2 = 0
...
function LevelBehavior31003:Update()
	...
	if self.missionState == 0 then
		...
		self.monster2 = BehaviorFunctions.CreateEntity(900040,nil,self.pos2.x-10,self.pos2.y,self.pos2.z)
		self.monster3 = BehaviorFunctions.CreateEntity(900040,nil,self.pos2.x,self.pos2.y,self.pos2.z+10)
		--self.monster4 = BehaviorFunctions.CreateEntity(900040,nil,self.pos2.x,self.pos2.y,self.pos2.z-3)
...
--死亡事件
function LevelBehavior31003:RemoveEntity(instanceId)
...
function LevelBehavior31003:__delete()

end

function LevelBehavior31003:GMSetMonsterId(id)
