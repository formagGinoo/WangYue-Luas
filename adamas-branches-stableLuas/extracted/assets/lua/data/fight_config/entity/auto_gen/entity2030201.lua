Config = Config or {}
Config.Entity2030201 = Config.Entity2030201 or { }
local empty = { }
Config.Entity2030201 = 
{
  [ 2030201 ] = {
    EntityId = 2030201,
    Components = {
      Transform = {
        Prefab = "CommonEntity/Flowerwall/Prefab/FlowerWall.prefab",
        Model = "FlowerWall",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
  ...
  [ 203020102 ] = {
    ...
    Components = {
      ...
      Transform = {
        Prefab = "CommonEntity/Flowerwall/Effect/FxFlowerWallDeath.prefab",
        Model = "FxFlowerWallDeath",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
