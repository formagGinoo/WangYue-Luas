Config = Config or {}
Config.Entity2040851 = Config.Entity2040851 or { }
local empty = { }
Config.Entity2040851 = 
{
  [ 2040851 ] = {
    EntityId = 2040851,
    Components = {
      Transform = {
        Prefab = "CommonEntity/Vehicle/JiaoChe/Prefab/JiaoChe00101.prefab",
        Model = "JiaoChe00101",
        isClone = true,
        MinDistance = 0.0,
        MaxDistance = 1.0,
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                ParentName = "Collider",
                LocalPosition = { 0.0, 0.85, -0.018 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 2.17350841, 1.2077179, 5.31497145 },
      ...
      Animator = {
        Animator = "CommonEntity/Vehicle/JiaoChe/Animation/JiaoChe001/JiaoChe001.controller",
        AnimationConfigID = "",
