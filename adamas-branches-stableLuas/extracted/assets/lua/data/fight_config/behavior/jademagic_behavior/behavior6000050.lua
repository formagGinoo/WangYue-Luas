...
--伤害判断
function Behavior6000050:BeforeCalculateDamage(ownerInstanceId,hitInstanceId, attackType, damageType, atkElementType, magicId, attackInstanceId)
	if hitInstanceId == self.me and self.safeTime > 0 then
		self.safeTime = self.safeTime - 1
		BehaviorFunctions.ChangeDamageParam(FightEnum.DamageParam.DmgDefercent, 0.1)
