TaskBehavior104020301 = BaseClass("TaskBehavior104020301")
--第三章通用模板

function TaskBehavior104020301.GetGenerates()
	local generates = {}
	return generates
end

function TaskBehavior104020301:__init(taskInfo)
...
function TaskBehavior104020301:Update()
