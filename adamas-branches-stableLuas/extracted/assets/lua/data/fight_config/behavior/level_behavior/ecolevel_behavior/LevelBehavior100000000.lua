LevelBehavior100000000 = BaseClass("LevelBehavior100000000",LevelBehaviorBase)
--大悬钟，搬运电梯玩法
function LevelBehavior100000000.GetGenerates()
	local generates = {2080101,2080102,2080103,2990101}
	return generates
end


function LevelBehavior100000000:Init()
	self.missionState = 0
	self.time = nil
	self.frame = nil
	self.role = nil
...
function LevelBehavior100000000:Update()
	...
	elseif self.missionState == 1 then
		self.blueprintIndex = Fight.Instance.clientFight.buildManager.buildController:TempCreateBlueprint(nil,{x = 1848,y = 174,z = 1258}, {x =0,y = 35,z = 0})
		self.missionState = 2
...
function LevelBehavior100000000:RemoveLevel(levelId)

end

--赋值
function LevelBehavior100000000:Assignment(variable,value)
	self[variable] = value
end


function LevelBehavior100000000:CreateActor(List)
...
function LevelBehavior100000000:PosCheck(List)
	for i,v in ipairs(List) do
...
function LevelBehavior100000000:TempCreateBluePrint(index, instanceId)
