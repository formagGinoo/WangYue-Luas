LevelBehavior32000101 = BaseClass("LevelBehavior32000101",LevelBehaviorBase)
--无buff神荼挑战

function LevelBehavior32000101.GetGenerates()
	local generates = {709200300}
	return generates
end


function LevelBehavior32000101:__init(taskInfo)
	self.enemyList = {
...
function LevelBehavior32000101:Update()
...
function LevelBehavior32000101:summonMonster()
	for i,v in ipairs(self.enemyList) do
		...
		if pos and rot then
			v.id = BehaviorFunctions.CreateEntity(v.enemyId, nil, pos.x, pos.y, pos.z, nil, nil, nil, self.levelId,5)
...
function LevelBehavior32000101:Death(instanceId,isFormationRevive)
	for i,v in ipairs(self.enemyList) do
...
function LevelBehavior32000101:AddEntitySign(instanceId,sign)
	--进入神荼2阶段处理
...
function LevelBehavior32000101:RemoveEntitySign(instanceId,sign)
	if instanceId == self.enemyList[1].id and sign == 92003018 then
...
function LevelBehavior32000101:LevelLookAtPos(pos,type,frame,bindTransform)
