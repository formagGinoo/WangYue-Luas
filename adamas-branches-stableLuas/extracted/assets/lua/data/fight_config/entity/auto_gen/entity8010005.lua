Config = Config or {}
Config.Entity8010005 = Config.Entity8010005 or { }
local empty = { }
Config.Entity8010005 = 
{
  [ 8010005 ] = {
    EntityId = 8010005,
    Components = {
      Transform = {
        Prefab = "Character/Npc/Male180/MaleNpc01005/MaleNpc01005.prefab",
        Model = "MaleNpc01005",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
      ...
      HackingInputHandle = {
        HackingType = 3,
        Name = "中分男",
        Icon = "Textures/Icon/Single/HeadIcon/SquNJuminnan01.png",
        Desc = "靠谱的成年男性",
        EffectType = 2,
