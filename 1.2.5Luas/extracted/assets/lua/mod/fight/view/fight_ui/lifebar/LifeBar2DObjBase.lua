...
function LifeBar2DObjBase:Init(clientEntity, parent, config)
	...
	self.attrs = self.entity.attrComponent.attrs
	self.config = config
...
function LifeBar2DObjBase:UpdateLifeBar(hit)
	...
	local curLife = self.attrs[EntityAttrsConfig.AttrType.Life]
	local maxLife = self.attrs[EntityAttrsConfig.AttrType.MaxLife]
...
function LifeBar2DObjBase:UpdateArmorBar()
	...
	local curArmor = self.attrs[EntityAttrsConfig.AttrType.Armor]
	local maxArmor = self.attrs[EntityAttrsConfig.AttrType.MaxArmor]
