LevelBehavior200501003 = BaseClass("LevelBehavior200501003",LevelBehaviorBase)


function LevelBehavior200501003.GetGenerates()
	local generates = {203040201,203040202}
	return generates
end


function LevelBehavior200501003:__init(fight)
	self.fight = fight
	self.missionState = 0
...
--function LevelBehavior200501003:LevelStartCountDown()
