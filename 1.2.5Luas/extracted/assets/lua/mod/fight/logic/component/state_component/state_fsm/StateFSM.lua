...
function StateFSM:InitStates()
	...
	self:AddState(EntityState.StrideOver, objectPool:Get(StrideOverMachine))
...
local statesCanSwitchSelf = {EntityState.Hit, EntityState.Move, EntityState.Jump, EntityState.Swim, EntityState.Climb, EntityState.CloseMenu}
