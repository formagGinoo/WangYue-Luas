...
function SwimFSM:Update()
	...
	self.entity.swimComponent:DoMoveForward(self.speed * FightUtil.deltaTimeSecond * timeScale)
end
...
function SwimFSM:StartSwim()
	...
	EventMgr.Instance:Fire(EventName.OnEntitySwim, self.entity.instanceId)
