Config = Config or {}
Config.Entity8011001 = Config.Entity8011001 or { }
local empty = { }
Config.Entity8011001 = 
{
  [ 8011001 ] = {
    EntityId = 8011001,
    Components = {
      Transform = {
        Prefab = "Character/Npc/Female165/FemaleNpc01001/FemaleNpc01001.prefab",
        Model = "FemaleNpc01001",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
      ...
      HackingInputHandle = {
        HackingType = 3,
        Name = "售货员",
        Icon = "Textures/Icon/Single/HeadIcon/SquNShouhuoyuannv.png",
        Desc = "",
        EffectType = 2,
