Config = Config or {}
Config.Entity8011009 = Config.Entity8011009 or { }
local empty = { }
Config.Entity8011009 = 
{
  [ 8011009 ] = {
    EntityId = 8011009,
    Components = {
      Transform = {
        Prefab = "Character/Npc/Female165/FemaleNpc01009/FemaleNpc01009.prefab",
        Model = "FemaleNpc01009",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
      ...
      HackingInputHandle = {
        HackingType = 3,
        Name = "青门祭祀",
        Icon = "Textures/Icon/Single/HeadIcon/SquNQingmennv.png",
        Desc = "青门祭祀女性",
        EffectType = 2,
