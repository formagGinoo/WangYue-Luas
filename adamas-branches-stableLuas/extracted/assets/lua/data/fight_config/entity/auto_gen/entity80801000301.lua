Config = Config or {}
Config.Entity80801000301 = Config.Entity80801000301 or { }
local empty = { }
Config.Entity80801000301 = 
{
  [ 80801000301 ] = {
    EntityId = 80801000301,
    Components = {
      Transform = {
        Prefab = "Character/Npc/Male180/MaleNpc01003/MaleNpc01003Fighttest.prefab",
        Model = "MaleNpc01003",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        ...
        PartList = {
          {
            ...
            BoneColliders = {
              {
                ShapeType = 3,
                ParentName = "MaleNpc01003",
                LocalPosition = { 0.0, 0.636, 0.0 },
