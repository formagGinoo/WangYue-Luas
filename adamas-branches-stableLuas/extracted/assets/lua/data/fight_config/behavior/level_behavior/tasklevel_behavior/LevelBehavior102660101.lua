LevelBehavior102660101 = BaseClass("LevelBehavior102660101",LevelBehaviorBase)
--无buff神荼挑战

function LevelBehavior102660101.GetGenerates()
	local generates = {709200300}
	return generates
end


function LevelBehavior102660101:__init(taskInfo)
	self.enemyList = {
	...
	self.storyIdList = {102410401,102410101,}
	self.deathCount = 0
	self.enemyCount = 0
	self.taskState = 0
...
function LevelBehavior102660101:Update()
...
function LevelBehavior102660101:summonMonster()
...
function LevelBehavior102660101:Death(instanceId,isFormationRevive)
	for i,v in ipairs(self.enemyList) do
...
function LevelBehavior102660101:AddEntitySign(instanceId,sign)
	--进入神荼2阶段处理
...
function LevelBehavior102660101:RemoveEntitySign(instanceId,sign)
	if instanceId == self.enemyList[1].id and sign == 92003018 then
...
function LevelBehavior102660101:LevelLookAtPos(pos,type,frame,bindTransform)
...
function LevelBehavior102660101:DistanceCheck()
...
function LevelBehavior102660101:StoryEndEvent(dialogId)
