LevelBehavior102050104 = BaseClass("LevelBehavior102050104",LevelBehaviorBase)
--创怪打怪恶来三只

function LevelBehavior102050104:__init(fight)
	self.fight = fight
end

function LevelBehavior102050104.GetGenerates()
	local generates = {790014000}
	return generates
end

function LevelBehavior102050104:Init()
	...
	self.TaskFightLevel.monsterList = {
		--第一波
		{entityId = 790014000, posName = "HunhunMoneyPos", instanceId = nil, lev = 0, wave = 1, isDead = false},
		{entityId = 790014000, posName = "HunhunMoneyPos01", instanceId = nil, lev = 0, wave = 1, isDead = false},
	}
...
function LevelBehavior102050104:Update()
	self.TaskFightLevel:Update()
end

function LevelBehavior102050104:__delete()
