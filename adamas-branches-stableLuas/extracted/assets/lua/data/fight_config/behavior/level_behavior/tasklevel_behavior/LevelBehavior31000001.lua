LevelBehavior31000001 = BaseClass("LevelBehavior31000001",LevelBehaviorBase)
--限时击杀怪物玩法
function LevelBehavior31000001:__init(fight)
	self.fight = fight
end


function LevelBehavior31000001.GetGenerates()
	local generates = {900040,910040}
	return generates
end


function LevelBehavior31000001:Init()
...
function LevelBehavior31000001:Update()
...
--清理战场
function LevelBehavior31000001:ResetBattle(monsterList)
...
--召唤敌人
function LevelBehavior31000001:SummonMonster(monsterList,monsterNumLimit)
...
--击杀全部怪物挑战检查
function LevelBehavior31000001:KillAllMonsterChallenge(monsterList)
	for i,v in ipairs(monsterList) do
...
function LevelBehavior31000001:TimeLimitChallange(startTime,timeLimit,condiTion,showTimeRemain)
...
--额外时长奖励
function LevelBehavior31000001:BounsTime(bonusTime)
	self.bonusTime = self.bonusTime + bonusTime
end

--挑战开始
function LevelBehavior31000001:ChallengeStart(challangeName)
...
--挑战结束
function LevelBehavior31000001:ChallengeFinish(challangeName,isSuccese)
	if isSuccese then
...
function LevelBehavior31000001:Die(attackInstanceId,instanceId)
...
function LevelBehavior31000001:Death(instanceId,isFormationRevive)
	--角色死亡判负
...
function LevelBehavior31000001:BeDodge(attackInstanceId,hitInstanceId,limit)
...
--死亡事件
function LevelBehavior31000001:RemoveEntity(instanceId)

end


function LevelBehavior31000001:__delete()
