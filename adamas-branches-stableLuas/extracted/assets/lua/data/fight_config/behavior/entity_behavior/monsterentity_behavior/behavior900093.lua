Behavior900093 = BaseClass("Behavior900093",EntityBehaviorBase)
...
function Behavior900093.GetGenerates()
	local generates = {}
	return generates
end


function Behavior900093:Init()
...
function Behavior900093:Update()
	self.role = BehaviorFunctions.GetCtrlEntity()
	local firstPos = BehaviorFunctions.GetTerrainPositionP("XW31",10020004,"PV999")
	local sayPos = BehaviorFunctions.GetTerrainPositionP("XW32",10020004,"PV999")
	local lastPos = BehaviorFunctions.GetTerrainPositionP("XW33",10020004,"PV999")
...
function Behavior900093:StoryEndEvent(dialogId)
	if dialogId == 601011401 then
		BehaviorFunctions.CastSkillBySelfPosition(self.me,90009004)
	end
end
	
function Behavior900093:FinishSkill(instanceId,skillId,skillSign,skillType)
