...
function AimMachine:Init(fight,entity)
    ...
    self.aimFSM.parentFSM = self.parentFSM
    self.aimFSM.stateId = self.stateId
end
...
function AimMachine:CanFall()
    return false
end

function AimMachine:GetSubState()
	return self.aimFSM:GetState()
end
