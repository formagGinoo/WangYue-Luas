LevelBehavior200501001 = BaseClass("LevelBehavior200501001",LevelBehaviorBase)


function LevelBehavior200501001.GetGenerates()
	local generates = {203040201,203040202}
	return generates
end


function LevelBehavior200501001:__init(fight)
	self.fight = fight
	self.missionState = 0
...
function LevelBehavior200501001:Update()
	...
	elseif self.missionState == 1 then
		...
		--失败条件：超出时间限制
		local result3 = self.LevelCommon:FailCondition_TimeLimit(30)
...
--function LevelBehavior200501001:LevelStartCountDown()
