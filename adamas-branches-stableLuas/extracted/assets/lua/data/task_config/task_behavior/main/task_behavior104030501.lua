TaskBehavior104030501 = BaseClass("TaskBehavior104030501")
--第三章通用模板

function TaskBehavior104030501.GetGenerates()
	local generates = {}
	return generates
end

function TaskBehavior104030501:__init(taskInfo)
...
function TaskBehavior104030501:Update()
