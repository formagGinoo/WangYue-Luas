...
function Behavior20001:WorldInteractClick(uniqueId)
...
function Behavior20001:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	...
	self.interactUniqueId = BehaviorFunctions.WorldInteractActive(WorldEnum.InteractType.Item, 200001, '宝箱', 1)--self.interactionUniqueId是按钮的id
end
