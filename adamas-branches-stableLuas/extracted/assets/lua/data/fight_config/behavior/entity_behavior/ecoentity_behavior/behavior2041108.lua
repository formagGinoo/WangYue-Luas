Behavior2041108 = BaseClass("Behavior2041108",EntityBehaviorBase) --在怪物身上使用CheckEcoEntityGroup,来决定是否要调用这个函数。
--资源预加载
function Behavior2041108.GetGenerates()
	local generates = {}
	return generates
end

function Behavior2041108:Init()
	self.LinelevelID = 405020202
...
function Behavior2041108:Update()
