Config = Config or {}
Config.Entity2040824 = Config.Entity2040824 or { }
local empty = { }
Config.Entity2040824 = 
{
  [ 2040824 ] = {
    EntityId = 2040824,
    Components = {
      Transform = {
        Prefab = "CommonEntity/Vehicle/GongXiang/Prefab/GongXiang00104.prefab",
        Model = "GongXiang00104",
        isClone = true,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                ParentName = "Collider",
                LocalPosition = { 0.0, 0.836, 0.0 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 1.71172488, 1.36134839, 3.00317764 },
      ...
      Animator = {
        Animator = "CommonEntity/Vehicle/GongXiang/Animation/Gongxiang001/GongXiang001.controller",
        AnimationConfigID = "",
