LevelBehavior10011005 = BaseClass("LevelBehavior10011005",LevelBehaviorBase)
--肉鸽测试关卡:浮空岛基础战斗01
function LevelBehavior10011005:__init(fight)
	self.fight = fight
end


function LevelBehavior10011005.GetGenerates()
	local generates = {900040,910040,2030502,203051113,20305080002,20305023,20305080101,203050804,900070,900071,900080}
	return generates
end


function LevelBehavior10011005:Init()
	...
	self.gravityList =
	{
		[1] = {state = self.monsterStateEnum.Default,wave =1,distance = 0,pos=0,radius = 38,inRadius = false,round = false, roundDeep = 5},
	}
...
function LevelBehavior10011005:LateInit()
	----设置任务开始位置
...
function LevelBehavior10011005:Update()
...
--检查玩家角色是否处于关卡范围内
function LevelBehavior10011005:CheckPlayerInRange(distance)
...
--肉鸽追踪
function LevelBehavior10011005:RogueGuidePointer(guidePos,guideDistance,guideType)
	local playerPos = BehaviorFunctions.GetPositionP(self.role)
...
--进入实体范围
function LevelBehavior10011005:EnterTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
...
--退出实体范围
function LevelBehavior10011005:ExitTrigger(triggerInstanceId,triggerEntityId,roleInstanceId)
	if roleInstanceId == self.role then
		if triggerInstanceId == self.levelFlag then
...
--实体按钮交互
function LevelBehavior10011005:WorldInteractClick(uniqueId,instanceId)
...
--召唤敌人
function LevelBehavior10011005:SummonMonster(monsterList,monsterDotList,monsterNumLimit)
...
--召唤重力装置
function LevelBehavior10011005:SummonGravity(gravityList,gravityDotList)
...
--解决全部敌人
function LevelBehavior10011005:KillAllMonsterChallenge(monsterList,gravityList)
	for i,v in ipairs(monsterList) do
...
function LevelBehavior10011005:Die(attackInstanceId,instanceId)
	--怪物死亡计数
...
function LevelBehavior10011005:Death(instanceId,isFormationRevive)
	--角色死亡判负
...
--检查坐标点是否处于画面中
function LevelBehavior10011005:CheckPosInCam(Position)
...
function LevelBehavior10011005:OnSwitchPlayerCtrl(oldInstanceId, instanceId)
