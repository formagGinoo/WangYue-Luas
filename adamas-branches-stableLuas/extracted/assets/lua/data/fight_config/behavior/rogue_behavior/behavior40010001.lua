Behavior40010001 = BaseClass("Behavior40010001",EntityBehaviorBase)
...
function Behavior40010001.GetGenerates()
end

function Behavior40010001.GetMagics()
	local generates = {}
	return generates
end

function Behavior40010001:Init()
