...
Config.Magic600050.Buffs = 
{
  ...
  [ 60005004 ] = {
    ...
    EffectInfos = {
      {
        EffectPath = "Effect/Prefab/Fight/FxSoulBip001Head.prefab",
  ...
  [ 60005005 ] = {
    ...
    EffectInfos = {
      {
        EffectPath = "Effect/Prefab/Fight/FxEnchant.prefab",
        EffectBindBones = "",
        EffectOffset = { 0.0, 0.0, 0.0 },
        DontBindRotation = false,
        OnlyUpdateY = false
  ...
  [ 60005006 ] = {
    ...
    EffectInfos = {
      {
        EffectPath = "Effect/Prefab/Fight/FxEnchantAiming.prefab",
        EffectBindBones = "Bip001LHand",
        EffectOffset = { 0.0, 0.0, 0.0 },
        DontBindRotation = false,
        OnlyUpdateY = false
      }
