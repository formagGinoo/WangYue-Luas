Config = Config or {}
Config.Entity2030531 = Config.Entity2030531 or { }
local empty = { }
Config.Entity2030531 = 
{
  [ 2030531 ] = {
    EntityId = 2030531,
    Components = {
      Transform = {
        Prefab = "CommonEntity/HackThing/Shoumaiji/Prefab/Shoumaiji.prefab",
        Model = "Shoumaiji",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
      ...
      HackingInputHandle = {
        ...
        RightHackingActiveType = {
          ...
          ActiveButtonIcon = "hack_cancel",
          ActiveHackingButtonName = "取消激活",
          ActiveHackingRam = 0,
          HackingDesc = "骇入以生成电磁场，再次执行会取消电磁场"
        },
        ...
        PartList = {
          {
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                LocalPosition = { 0.0, 1.857, 0.0 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 1.4959079, 2.87445426, 0.73543644 }
              }
            },
            DefaultEnable = true,
            ColliderFollow = 1,
        ...
        PartList = {
          {
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                LocalPosition = { 0.0, 1.464, 0.0 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 1.01054752, 2.54114342, 1.4695 }
              }
            },
            LogicSearch = true,
            SearchWeight = 0.0,
