LevelBehavior32000010 = BaseClass("LevelBehavior32000010",LevelBehaviorBase)
--梦魇初2-1


function LevelBehavior32000010.GetGenerates()
	local generates = {2000,790002000,790013000,790006000,791004000}
	return generates
end

function LevelBehavior32000010:__init(fight)
	self.fight = fight
end


function LevelBehavior32000010:Init()
	...
	self.monsterList =
	{
		[1] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 1 ,lev = 36 ,entityId = 790002000},  --1土石龙
		[2] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 1 ,lev = 36 ,entityId = 790002000},  --1土石龙
		[3] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon3" ,wave = 1 ,lev = 36 ,entityId = 790013000},  --1从事弓
		[4] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon4" ,wave = 1 ,lev = 36 ,entityId = 790013000},  --1从事弓
		[5] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 2 ,lev = 36 ,entityId = 790006000},  --2尾狐
		[6] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 2 ,lev = 36 ,entityId = 790006000},  --2尾狐
		[7] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon3" ,wave = 2 ,lev = 36 ,entityId = 791004000},  --2精英从士
		[8] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon4" ,wave = 2 ,lev = 36 ,entityId = 791004000},  --2精英从士
	}
...
function LevelBehavior32000010:Update()
	...
	if self.missionState == 0 then
		...
		local fp1 = BehaviorFunctions.GetTerrainPositionP("mon2",32000010)
...
function LevelBehavior32000010:CreatMonster(wave)
...
function LevelBehavior32000010:Death(instanceId,isFormationRevive)
	--计算怪物全部死亡
	for i,v in ipairs(self.monsterList) do
		--计算当前波次怪物死亡数
...
--BehaviorFunctions.ShowTip(32000010)
--end
...
function LevelBehavior32000010:__delete()
