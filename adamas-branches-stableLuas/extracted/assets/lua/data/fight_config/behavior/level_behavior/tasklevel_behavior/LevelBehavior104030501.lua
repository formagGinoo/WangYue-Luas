LevelBehavior104030501 = BaseClass("LevelBehavior104030501",LevelBehaviorBase)
--刷大海处的怪

function LevelBehavior104030501:__init(fight)
	self.fight = fight
end

function LevelBehavior104030501.GetGenerates()
	local generates = {
        900040,   --木从士
        900041,   --火从士
        900042,   --冰从士
...
function LevelBehavior104030501:Init()
	self.missionState = 0
    self.role = nil
    self.posName = "SaveNpc02"
	self.deathCount = 0
	self.monsterList = {
        910040,900050,900051
    }
    self.dialogId = 102280901
end

function LevelBehavior104030501:Update()
	self.role = BehaviorFunctions.GetCtrlEntity()
    self:CreateMonster()
end

function LevelBehavior104030501:__delete()

end

--在某个点附近创建怪
function LevelBehavior104030501:CreateMonster()
...
--死亡事件
function LevelBehavior104030501:Death(instanceId,isFormationRevive)
...
function LevelBehavior104030501:LevelFinish()
	BehaviorFunctions.SendTaskProgress(self.levelId + 100, 1, 1)
	BehaviorFunctions.RemoveLevel(self.levelId)
end

function LevelBehavior104030501:StoryEndEvent(dialogId)
