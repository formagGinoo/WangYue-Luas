LevelBehavior302040801 = BaseClass("LevelBehavior302040801",LevelBehaviorBase)

function LevelBehavior302040801:__init(fight)
	self.fight = fight
...
function LevelBehavior302040801.GetGenerates()
	local generates = {790012000,2041101,808011001}
	return generates
end

function LevelBehavior302040801.GetMagics()
	local generates = {}
	return generates
end

function LevelBehavior302040801:Init()
	--肉鸽事件信息获取
...
function LevelBehavior302040801:Update()
...
function LevelBehavior302040801:__delete()
end

---------------------回调----------------------------------
--结尾对话播放完毕
function LevelBehavior302040801:StoryEndEvent(dialogId)
...
--死亡回调
function LevelBehavior302040801:Death(instanceId,isFormationRevive)
...
--创怪函数
function LevelBehavior302040801:CreateMonster(wave)
	for i, v in pairs(self.monsterList) do
		--创该波的怪
		local pos = nil
		local rot = nil
...
--卸载内容
function LevelBehavior302040801:Leave()
...
--设置攻击目标
function LevelBehavior302040801:ChangeTarget(monsterList)
...
--关卡胜利表现
function LevelBehavior302040801:Victory()
...
--关卡失败表现
function LevelBehavior302040801:Fail()
...
--任务前置肉鸽追踪指标，以封装函数，不管
function LevelBehavior302040801:RogueGuidePointer(guidePos,guideDistance,guideType)
...
--追踪指标
function LevelBehavior302040801:GuidePointer(guidePos,guideDistance,minDistance,guideType)
	local playerPos = BehaviorFunctions.GetPositionP(self.role)
	local distance = BehaviorFunctions.GetDistanceFromPos(playerPos,guidePos)
...
--怪物巡逻
function LevelBehavior302040801:MonsterPatrol(monsterList)
	for i,v in ipairs (monsterList) do
		if v.instanceId ~= nil then
...
--相机函数
function LevelBehavior302040801:LevelLookAtPos(pos,logic,type,bindTransform,blendInTime,blendOutTime)
...
--屏蔽按键
function LevelBehavior302040801:DisablePlayerInput(isOpen,closeUI)
	--取消摇杆移动
...
function LevelBehavior302040801:AddLevelDelayCallByFrame(frame,obj,callback,...)
...
--移除所有关卡延时调用
function LevelBehavior302040801:RemoveAllLevelDelayCall()
