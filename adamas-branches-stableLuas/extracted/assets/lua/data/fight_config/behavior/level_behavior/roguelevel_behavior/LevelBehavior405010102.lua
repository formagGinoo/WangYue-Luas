LevelBehavior405010102 = BaseClass("LevelBehavior405010102",LevelBehaviorBase)
--肉鸽关卡:窃听识破揭露抽奖骗局
...
function LevelBehavior405010102:__init(fight)
	self.fight = fight
end

function LevelBehavior405010102.GetGenerates()
	local generates = {2070102,2030222,790014000}
	return generates
end


function LevelBehavior405010102:Init()
	...
	self.posList = {
		[1] = {posName = "table2", entityId = 2030222, instanceId = nil},
		[2] = {posName = "choujiangji2", entityId = 2070102, instanceId = nil},
	...
	--被骇入的npc列表
	self.npcInfo = {
		[1]= {id = 5881102, instanceId = nil, HackContent = 1,},--骇入内容，1短信2电话
	}
...
function LevelBehavior405010102:LateInit()

end

function LevelBehavior405010102:Update()
...
function LevelBehavior405010102:Remove()
...
--关卡创建点位获取
function LevelBehavior405010102:GetRogueLevelPos()
...
--物品创建
function LevelBehavior405010102:CreateSceneObjects()
...
--获取NPC实例id并处理状态
function LevelBehavior405010102:GetNpcAndSetState()
...
--设置npc电话和短信状态
function LevelBehavior405010102:SetNpcMailOrCallState()
	for i, v in ipairs(self.npcInfo) do
...
--气泡对话轮播
function LevelBehavior405010102:BubbleDialogLoop()
...
--创建依盖队
function LevelBehavior405010102:CreateYigaidui()
...
--骇入指引封装
function LevelBehavior405010102:HackTutorial()
...
--开启弱引导，并且关闭其他弱引导
function LevelBehavior405010102:WeakGuide(guideId)
	local result = false
...
--关闭所有弱引导
function LevelBehavior405010102:RemoveWeakGuide()
	for i,v in ipairs(self.weakGuide) do
		BehaviorFunctions.FinishGuide(v.Id,1)
	end
end
...
--赋值
function LevelBehavior405010102:Assignment(variable,value)
	self[variable] = value
end
...
--交互回调，和npc交互进行抽奖
function LevelBehavior405010102:WorldInteractClick(uniqueId, instanceId)
...
--死亡回调
function LevelBehavior405010102:Death(instanceId,isFormationRevive)
...
--回调，经过相关剧情
function LevelBehavior405010102:StoryPassEvent(dialogId)
...
--回调，完成相关剧情
function LevelBehavior405010102:StoryEndEvent(dialogId)
...
function LevelBehavior405010102:Hit(attackInstanceId,hitInstanceId,hitType,camp)
...
--开始窃听回调
function LevelBehavior405010102:HackingClickUp(instanceId)
...
--退出骇入回调
function LevelBehavior405010102:ExitHacking()
...
--骇入回调
function LevelBehavior405010102:Hacking(instanceId)
