LevelBehavior32000301 = BaseClass("LevelBehavior32000301",LevelBehaviorBase)
--离歌野外副本
function LevelBehavior32000301:__init(fight)
	self.fight = fight
end

function LevelBehavior32000301.GetGenerates()
	local generates = {70920011}
	return generates
end

function LevelBehavior32000301.GetStorys()
	local storys = {101070102,101071001}
	return storys
end

----程序黑幕
--function LevelBehavior32000301.NeedBlackCurtain()
--return true
--end

function LevelBehavior32000301:Init()
...
function LevelBehavior32000301:Update()
...
function LevelBehavior32000301:WeakGuide(guideId)
...
function LevelBehavior32000301:RemoveEntity(instanceId)

end

function LevelBehavior32000301:__delete()

end

--死亡事件
function LevelBehavior32000301:Die(attackInstanceId,dieInstanceId)
...
--死亡动画后事件
function LevelBehavior32000301:Death(instanceId,isFormationRevive)
	--玩家角色全部死亡，副本失败
...
function LevelBehavior32000301:BgmChangeLogic(group,groupNum,memberNum)
	if group then
...
function LevelBehavior32000301:LevelLookAtPos(pos,type,frame,bindTransform)
...
function LevelBehavior32000301:DisablePlayerInput(isOpen,closeUI)
	--取消摇杆移动
...
function LevelBehavior32000301:StoryStartEvent(dialogId)
...
function LevelBehavior32000301:StoryEndEvent(dialogId)
	for i,v in ipairs(self.dialogList) do
		if dialogId == v.Id then
...
--复活逻辑
function LevelBehavior32000301:Revive(instanceId, entityId)
...
--赋值
function LevelBehavior32000301:Assignment(variable,value)
	self[variable] = value
end

function LevelBehavior32000301:DuplicateCountdownFinish()
	LogError("111")
end
