...
LevelBehavior104020101 = BaseClass("104020101",LevelBehaviorBase)
--第四章巡卫战斗分支

function LevelBehavior104020101:__init(fight)
	self.fight = fight
end

function LevelBehavior104020101.GetGenerates()
	local generates = {790009001}  --巡卫
	return generates
end

function LevelBehavior104020101:Init()
...
function LevelBehavior104020101:Update()
	--角色为当前玩家操作角色
   ...
   --创怪
	if self.missionState == 0 then
		...
		BehaviorFunctions.ShowTip(100000001,"击败所有巡卫")
...
--创怪
function LevelBehavior104020101:CreateMonster(monsterList)
...
--修改怪物攻击目标以及怪物战斗状态
function LevelBehavior104020101:SetCombatTarget(monsterList)
...
--设置关卡相机函数
function LevelBehavior104020101:SetLevelCamera()
...
--死亡事件
function LevelBehavior104020101:Death(instanceId,isFormationRevive)
	...
	for k,v in ipairs(self.monsterList) do
		...
		if self.dieCount == 1 then
			BehaviorFunctions.StartStoryDialog(104031801)
			self.dieCount = 99
		end
	end
