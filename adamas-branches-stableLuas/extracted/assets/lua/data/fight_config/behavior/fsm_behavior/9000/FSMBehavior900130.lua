FSMBehavior900130 = BaseClass("FSMBehavior900130",FSMBehaviorBase)
--资源预加载
function FSMBehavior900130.GetGenerates()
	local generates = {}
	return generates
end
--mgaic预加载
function FSMBehavior900130.GetMagics()
	local generates = {900000024,900000025,900000107}
	return generates
end

function FSMBehavior900130:Init()
	...
	self.warnSkillId = 90013003            --警告技能Id
	self.warnSitSkillId = 90013004         --坐下后起立警告技能Id
	self.tauntSkillId = nil           --嘲讽技能
	self.noWarnInFightRange = 40       --havewarn ==false时 进战斗的距离
	...
	self.LRWalkSwitchTime = 3.334		--左右走切换时间
	...
	self.defaultSkillId = 90005002		--默认技能id，追杀模式使用
...
function FSMBehavior900130:LateInit()
...
function FSMBehavior900130:Update()
...
function FSMBehavior900130:DeathEnter(instanceId,isFormationRevive)
...
function FSMBehavior900130:Die(attackInstanceId,dieInstanceId)
...
--检测暗杀目标移除
function FSMBehavior900130:RemoveBuff(entityInstanceId, buffInstanceId,buffId)
...
function FSMBehavior900130:BeforeDie(instanceId)
	if instanceId == self.me then
