...
function Behavior910025:Init()
	...
	self.MonsterCommonParam.tauntSkillId = 910025005         --嘲讽技能
	...
	self.MonsterCommonParam.commonSkillCd = 0.2			   --技能公共cd
...
function Behavior910025:BreakSkill(instanceId,skillId,skillType)
	if  skillId == 910025011 and instanceId == self.MonsterCommonParam.me then
		skillId = nil
		BehaviorFunctions.DoLookAtTargetImmediately(self.MonsterCommonParam.me,self.MonsterCommonParam.battleTarget)
		BehaviorFunctions.CastSkillByTarget(self.MonsterCommonParam.me,910025012,self.MonsterCommonParam.battleTarget)
		--特殊處理：清除預備技能列表
...
function Behavior910025:CastSkill(instanceId,skillId,skillType)
