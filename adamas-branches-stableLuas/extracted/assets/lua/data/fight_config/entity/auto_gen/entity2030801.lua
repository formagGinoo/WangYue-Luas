Config = Config or {}
Config.Entity2030801 = Config.Entity2030801 or { }
local empty = { }
Config.Entity2030801 = 
{
  [ 2030801 ] = {
    EntityId = 2030801,
    Components = {
    ...
    Components = {
      ...
      Sound = {
        SoundEventList = {
          {
            EventType = 1,
            SoundEvent = "ElectChargeDevice_Charge",
            DelayTime = 0.0,
    ...
    Components = {
      ...
      Sound = {
        SoundEventList = {
          {
            EventType = 1,
            SoundEvent = "ElectChargeDevice_ActiveModeLoop",
            DelayTime = 0.0,
            LifeBindEntity = true
          }
        },
