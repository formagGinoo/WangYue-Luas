...
function FlyHoverMachine:OnEnter()
	...
	self.entity.clientEntity.clientTransformComponent:DoAnimationYFusion(pivot - animY, 0.1)
end
...
function FlyHoverMachine:OnLeave()
	-- self.entity.clientEntity.clientTransformComponent:DoAnimationYFusion()
end
