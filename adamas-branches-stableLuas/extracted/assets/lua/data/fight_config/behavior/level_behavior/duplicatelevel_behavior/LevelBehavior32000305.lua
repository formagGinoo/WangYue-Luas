LevelBehavior32000305 = BaseClass("LevelBehavior32000305",LevelBehaviorBase)
--离歌野外副本
function LevelBehavior32000305:__init(fight)
	self.fight = fight
end

function LevelBehavior32000305.GetGenerates()
	local generates = {70920011}
	return generates
end

function LevelBehavior32000305.GetStorys()
	local storys = {101070102,101071001}
	return storys
end

----程序黑幕
--function LevelBehavior32000305.NeedBlackCurtain()
--return true
--end

function LevelBehavior32000305:Init()
...
function LevelBehavior32000305:Update()
...
function LevelBehavior32000305:WeakGuide(guideId)
...
function LevelBehavior32000305:RemoveEntity(instanceId)

end

function LevelBehavior32000305:__delete()

end

--死亡事件
function LevelBehavior32000305:Die(attackInstanceId,dieInstanceId)
...
--死亡动画后事件
function LevelBehavior32000305:Death(instanceId,isFormationRevive)
	--玩家角色全部死亡，副本失败
...
function LevelBehavior32000305:BgmChangeLogic(group,groupNum,memberNum)
	if group then
...
function LevelBehavior32000305:LevelLookAtPos(pos,type,frame,bindTransform)
...
function LevelBehavior32000305:DisablePlayerInput(isOpen,closeUI)
	--取消摇杆移动
...
function LevelBehavior32000305:StoryStartEvent(dialogId)
...
function LevelBehavior32000305:StoryEndEvent(dialogId)
	for i,v in ipairs(self.dialogList) do
		if dialogId == v.Id then
...
--复活逻辑
function LevelBehavior32000305:Revive(instanceId, entityId)
...
--赋值
function LevelBehavior32000305:Assignment(variable,value)
	self[variable] = value
end

function LevelBehavior32000305:DuplicateCountdownFinish()
	LogError("111")
end
