LevelBehavior32000007 = BaseClass("LevelBehavior32000007",LevelBehaviorBase)
--梦魇-初难度1-2


function LevelBehavior32000007.GetGenerates()
	local generates = {2000,790012000,790013000,790006000}
	return generates
end

function LevelBehavior32000007:__init(fight)
	self.fight = fight
end


function LevelBehavior32000007:Init()
	...
	self.monsterList =
	{
		[1] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 1 ,lev = 23 ,entityId = 790012000},  --1从士
		[2] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 1 ,lev = 23 ,entityId = 790013000},  --1从士射手
		[3] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon3" ,wave = 1 ,lev = 23 ,entityId = 790006000},  --1尾狐
		[4] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon4" ,wave = 1 ,lev = 23 ,entityId = 790006000},  --1尾狐
		[5] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 2 ,lev = 23 ,entityId = 790012000},  --2从士
		[6] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 2 ,lev = 23 ,entityId = 790013000},  --2从士射手
		[7] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon3" ,wave = 2 ,lev = 23 ,entityId = 790013000},  --2从士射手
		[8] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon4" ,wave = 2 ,lev = 23 ,entityId = 790006000},  --2尾狐
	}
...
function LevelBehavior32000007:Update()
	...
	if self.missionState == 0 then
		...
		local fp1 = BehaviorFunctions.GetTerrainPositionP("mon2",32000007)
...
function LevelBehavior32000007:CreatMonster(wave)
...
function LevelBehavior32000007:Death(instanceId,isFormationRevive)
	--计算怪物全部死亡
	for i,v in ipairs(self.monsterList) do
		--计算当前波次怪物死亡数
...
function LevelBehavior32000007:__delete()
