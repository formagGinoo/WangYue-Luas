LevelBehavior1040802 = BaseClass("LevelBehavior1040802",LevelBehaviorBase)
--击败两名从士
function LevelBehavior1040802:__init(fight)
	self.fight = fight
end

function LevelBehavior1040802.GetGenerates()
	local generates = {900040,900042,2030202}
	return generates
end

function LevelBehavior1040802.GetStorys()
	local storys = {}
	return storys
end


function LevelBehavior1040802:Init()
...
function LevelBehavior1040802:Update()
	self.role = BehaviorFunctions.GetCtrlEntity()
...
function LevelBehavior1040802:DisablePlayerInput(isOpen,closeUI)
	--取消摇杆移动
...
function LevelBehavior1040802:LevelLookAtPos(pos,type,frame,bindTransform)
...
--技能循环引导
function LevelBehavior1040802:SkillGuide()
...
--创建墙体
function LevelBehavior1040802:CreateWall(list)
...
--移除墙体
function LevelBehavior1040802:RemoveWall(list)
	for i,v in ipairs (list) do
		if v.Id ~= nil then
...
--图片引导开启/关闭检测
function LevelBehavior1040802:OnGuideImageTips(tipsId,isOpen)
...
--开启弱引导，并且关闭其他弱引导
function LevelBehavior1040802:WeakGuide(guideId)
	local result = false
...
--关闭所有弱引导
function LevelBehavior1040802:RemoveWeakGuide()
	for i,v in ipairs(self.weakGuide) do
		BehaviorFunctions.FinishGuide(v.Id,1)
	end
end

function LevelBehavior1040802:OnGuideFinish(guideId,stage)
...
function LevelBehavior1040802:RemoveEntity(instanceId)

end

function LevelBehavior1040802:__delete()

end

--死亡事件
function LevelBehavior1040802:Death(instanceId,isFormationRevive)
...
function LevelBehavior1040802:StoryEndEvent(dialogId)
...
function LevelBehavior1040802:StoryStartEvent(dialogId)

end

function LevelBehavior1040802:PathFindingBegin(instanceId,pos)
...
function LevelBehavior1040802:PathFindingEnd(instanceId,result)
...
--赋值
function LevelBehavior1040802:Assignment(variable,value)
	self[variable] = value
end

---返回范围内没有障碍的位置
function LevelBehavior1040802:ReturnPosition(target,distance,startAngel,endAngel,checkheight,checkCollision,returnFarthestPos)
	local posTable = {}
