LevelBehavior200502001 = BaseClass("LevelBehavior200502001",LevelBehaviorBase)

function LevelBehavior200502001.GetGenerates()
...
function LevelBehavior200502001.GetMagics()
	local generates = {1000111,
	}
	return generates
end

function LevelBehavior200502001:__init(fight)
	self.fight = fight
	self.isCount = false
...
function LevelBehavior200502001:Init()
	self.role = 0		--角色
	...
	--通风管道
	self.PipeEcoIdA = 2003001150001
	self.PipeEcoIdB = 2003001150002
	self.Pipe = nil
...
function LevelBehavior200502001:Update()
...
--获取玩家所在区域
function LevelBehavior200502001:EnterArea(triggerInstanceId, areaName, logicName)
...
--玩家退出区域
function LevelBehavior200502001:ExitArea(triggerInstanceId, areaName, logicName)
	if triggerInstanceId == self.role then
		if areaName == self.inDoorSpeace then
			self.roleSpaceStationA = self.spaceStation.outDoor
		end
...
--骇入逻辑
function LevelBehavior200502001:HackingClickUp(instanceId)
	--骇入摄像头
...
function LevelBehavior200502001:FirstCollide(attackInstanceId,hitInstanceId,instanceId,attackType,skillType, atkElement)
    -- 获取攻击实例对应的笔记本爆炸对象
...
--剧情对话结束--关卡胜利
function LevelBehavior200502001:StoryEndEvent(dialogId)
...
--死亡回调
function LevelBehavior200502001:Death(instanceId,isFormationRevive)
...
--关闭/关闭 物体骇入功能
function LevelBehavior200502001:HackClose(EntityID,Bool)
	BehaviorFunctions.SetEntityHackEnable(EntityID,Bool)
	BehaviorFunctions.SetEntityHackActiveState(EntityID, Bool)
end

function LevelBehavior200502001:updateDistance(playerPos,role)
...
--追踪指标
function LevelBehavior200502001:GuidePointer(guidePos,guideDistance,minDistance,guideType)
...
--创建怪物
function LevelBehavior200502001:CreateMonster(monsterList)
...
--移除怪物
function LevelBehavior200502001:RemoveEntityId(entityId)
...
--怪物巡逻
function LevelBehavior200502001:MonsterPatrol(monsterList)
	for i,v in ipairs (monsterList) do
		if v.Id ~= nil then
...
--修改后门是否可开关
function LevelBehavior200502001:canDoorOpen(DoorListId)
...
--开启所有大门
function LevelBehavior200502001:OpenAllDoor(DoorList)
...
--Npc站起来
function LevelBehavior200502001:NpcStand(Npclist)
...
--还原生态通风管参数
function LevelBehavior200502001:RemoveEcoState(EcoId,State)
	if EcoId ~= nil then
...
--相机函数
function LevelBehavior200502001:LevelLookAtPos(pos,type,bindTransform)
...
function LevelBehavior200502001:AddLevelDelayCallByFrame(frame,obj,callback,...)
...
--移除所有关卡延时调用
function LevelBehavior200502001:RemoveAllLevelDelayCall()
...
function LevelBehavior200502001:GetShockByInstanceId(instanceId)
...
--卸载关卡
function LevelBehavior200502001:LevelDelete()
