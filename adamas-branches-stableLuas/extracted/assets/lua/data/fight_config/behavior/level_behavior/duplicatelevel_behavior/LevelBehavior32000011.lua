LevelBehavior32000011 = BaseClass("LevelBehavior32000011",LevelBehaviorBase)
--梦魇初2-2


function LevelBehavior32000011.GetGenerates()
	local generates = {2000,790007000,790007100,790008000,790010200,790002000,790006000}
	return generates
end

function LevelBehavior32000011:__init(fight)
	self.fight = fight
end


function LevelBehavior32000011:Init()
	...
	self.monsterList =
	{
		[1] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 1 ,lev = 39 ,entityId = 790007000},  --1斩火
		[2] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 1 ,lev = 39 ,entityId = 790007000},  --1斩火
		[3] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 1 ,lev = 39 ,entityId = 790007100},  --1斩土
		[4] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon5" ,wave = 1 ,lev = 39 ,entityId = 790008000},  --1真是之列
		[5] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon6" ,wave = 1 ,lev = 39 ,entityId = 790010200},  --1计都
		[6] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 2 ,lev = 39 ,entityId = 790002000},  --2土龙
		[7] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 2 ,lev = 39 ,entityId = 790002000},  --2土龙
		[8] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon3" ,wave = 2 ,lev = 39 ,entityId = 790006000},  --尾狐
		[9] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 2 ,lev = 39 ,entityId = 790006000},  --尾狐
...
function LevelBehavior32000011:Update()
	...
	if self.missionState == 0 then
		...
		local fp1 = BehaviorFunctions.GetTerrainPositionP("mon2",32000011)
...
function LevelBehavior32000011:CreatMonster(wave)
...
function LevelBehavior32000011:Death(instanceId,isFormationRevive)
	--计算怪物全部死亡
	for i,v in ipairs(self.monsterList) do
		--计算当前波次怪物死亡数
...
--BehaviorFunctions.ShowTip(32000011)
--end
...
function LevelBehavior32000011:__delete()
