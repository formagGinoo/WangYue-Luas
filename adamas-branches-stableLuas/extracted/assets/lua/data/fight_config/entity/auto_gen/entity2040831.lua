Config = Config or {}
Config.Entity2040831 = Config.Entity2040831 or { }
local empty = { }
Config.Entity2040831 = 
{
  [ 2040831 ] = {
    EntityId = 2040831,
    Components = {
      Transform = {
        Prefab = "CommonEntity/Vehicle/SUV/Prefab/SUV00101.prefab",
        Model = "SUV00101",
        isClone = true,
        MinDistance = 0.0,
        MaxDistance = 1.0,
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                ParentName = "Collider",
                LocalPosition = { 0.0, 0.9, -0.045 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 2.147709, 1.66786826, 5.30879259 },
      ...
      Animator = {
        Animator = "CommonEntity/Vehicle/SUV/Animation/SUV001/SUV001.controller",
        AnimationConfigID = "",
