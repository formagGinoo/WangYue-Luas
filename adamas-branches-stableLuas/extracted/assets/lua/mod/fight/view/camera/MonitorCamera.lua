...
function MonitorCamera:ResetHV()
	local va = self.cameraPOV.m_VerticalAxis
	va.Value = 0
	self.cameraPOV.m_VerticalAxis = va
	local ha = self.cameraPOV.m_HorizontalAxis
	ha.Value = 0
	self.cameraPOV.m_HorizontalAxis = ha
end
