LevelBehavior200507005 = BaseClass("LevelBehavior200507005",LevelBehaviorBase)
--关卡测试关
function LevelBehavior200507005:__init(fight)
	self.fight = fight
end


function LevelBehavior200507005.GetGenerates()
	local generates = {900080,808011003,80801000301,790008000}
	return generates
end

function LevelBehavior200507005.GetMagics()
	local generates = {8080100030101,8080100030102}
	return generates
end

function LevelBehavior200507005:Init()
	--通用参数---------------------------------------------------------------------------------------------------------------------
...
function LevelBehavior200507005:Update()
...
function LevelBehavior200507005:Death(instanceId,isFormationRevive)
...
function LevelBehavior200507005:Die(attackInstanceId,dieInstanceId)
...
function LevelBehavior200507005:DuplicateCountdownFinish()
...
function LevelBehavior200507005:TimerCountFinish(timerId)
	if self.npcDead == false or self.yuelingDead == false then
		--self.gameLeftTime = BehaviorFunctions.ReturnDuplicateCountdownRemain()
		--if self.gameLeftTime <= 0 then
		BehaviorFunctions.SetDuplicateResult(false)
...
function LevelBehavior200507005:OnCountDownFinishEvent(levelId)
