LevelBehavior200507003 = BaseClass("LevelBehavior200507003",LevelBehaviorBase)
--关卡测试关
function LevelBehavior200507003:__init(fight)
	self.fight = fight
end


function LevelBehavior200507003.GetGenerates()
	local generates = {900120,808011003,80801000301,790012000}
	return generates
end

function LevelBehavior200507003.GetMagics()
	local generates = {8080100030101,8080100030102}
	return generates
end

function LevelBehavior200507003:Init()
	--通用参数---------------------------------------------------------------------------------------------------------------------
...
function LevelBehavior200507003:Update()
...
function LevelBehavior200507003:Death(instanceId,isFormationRevive)
...
function LevelBehavior200507003:Die(attackInstanceId,dieInstanceId)
...
function LevelBehavior200507003:DuplicateCountdownFinish()
...
function LevelBehavior200507003:TimerCountFinish(timerId)
	if self.npcDead == false or self.yuelingDead == false then
		--self.gameLeftTime = BehaviorFunctions.ReturnDuplicateCountdownRemain()
		--if self.gameLeftTime <= 0 then
		BehaviorFunctions.SetDuplicateResult(false)
...
function LevelBehavior200507003:OnCountDownFinishEvent(levelId)
