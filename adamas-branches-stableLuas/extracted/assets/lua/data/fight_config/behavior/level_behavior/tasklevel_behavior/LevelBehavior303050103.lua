LevelBehavior303050103 = BaseClass("LevelBehavior303050103",LevelBehaviorBase)

function LevelBehavior303050103:__init(fight)
	self.fight = fight
end

function LevelBehavior303050103.GetGenerates()
	local generates = {
...
function LevelBehavior303050103:Init()
	self.missionState = 0
	self.role = nil
...
function LevelBehavior303050103:Update()
	...
	if self.missionState == 0 then	--玩家信息
		local PlayRacePos = BehaviorFunctions.GetTerrainPositionP("PlayRace", 303050103)
		local PlayRaceRot = BehaviorFunctions.GetTerrainRotationP("PlayRace", 303050103)
		local Playlook = BehaviorFunctions.GetTerrainPositionP("PlayRaceCam", 303050103)
	...
	if self.missionState == 1 then
		local RuyingPos = BehaviorFunctions.GetTerrainPositionP("RuyingCarEnd", 303050103)
		local Ruyinglook = BehaviorFunctions.GetTerrainPositionP("pos2", 303050103)
	...
	if self.missionState == 3 then
		...
		if self.checkPosition == 1 then
			...
			if checkPRange < 20 then
				local checkP1 = BehaviorFunctions.GetTerrainPositionP("checkP1", 303050103)
				local checkPosRot1 = BehaviorFunctions.GetTerrainRotationP("checkP1",self.levelId)
		...
		if self.checkPosition == 2 then
			...
			if checkPRange < self.greenrange then
				local checkP1 = BehaviorFunctions.GetTerrainPositionP("checkP2", 303050103)
		...
		if self.checkPosition == 3 then
			...
			local checkPRange = BehaviorFunctions.GetDistanceFromPos(checkP,self.playercheckP)
			if checkPRange < self.greenrange then
				local checkP1 = BehaviorFunctions.GetTerrainPositionP("checkP3", 303050103)
		...
		if self.checkPosition == 4 then
			...
			local checkPRange = BehaviorFunctions.GetDistanceFromPos(checkP,self.playercheckP)
			if checkPRange < self.greenrange then
				local checkP1 = BehaviorFunctions.GetTerrainPositionP("checkP4", 303050103)
		...
		if self.checkPosition == 5 then
			...
			local checkPRange = BehaviorFunctions.GetDistanceFromPos(checkP,self.playercheckP)
			if checkPRange < self.greenrange then
				local checkP1 = BehaviorFunctions.GetTerrainPositionP("checkP5", 303050103)
	...
	if self.missionState == 3 then
		...
		if pra < 10 then
			...
			BehaviorFunctions.AddDelayCallByTime(7,BehaviorFunctions,BehaviorFunctions.SendTaskProgress,3030501, 1, 1, 1)
			-- BehaviorFunctions.SendTaskProgress(3030501, 3, 1, 1)

			BehaviorFunctions.AddDelayCallByTime(7,self,self.LevelFinish)
			-- self:LevelFinish()
...
function LevelBehavior303050103:__delete()
end

---------------------回调----------------------------------

--死亡回调
function LevelBehavior303050103:Death(instanceId,isFormationRevive)
end

-------------------------函数--------------------------------

--设置关卡相机函数
function LevelBehavior303050103:SetLevelCamera()
...
function LevelBehavior303050103:GetCarPath(posNameList)
	local posListCache = {}
	for k,v in ipairs(posNameList) do
		if v.posName then
			local pos = BehaviorFunctions.GetTerrainPositionP(v.posName,303050103)
...
function LevelBehavior303050103:GetDrawPos(DrawposList)
	local posListDraw = {}
	for k,v in ipairs(DrawposList) do
		if v.drawposName then
			local pos = BehaviorFunctions.GetTerrainPositionP(v.drawposName,303050103)
...
--关卡结束函数
function LevelBehavior303050103:LevelFinish()
