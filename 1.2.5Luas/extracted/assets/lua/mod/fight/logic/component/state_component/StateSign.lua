...
function StateSign:Init(fight,entity,lastTime,ignoreTimeScale,startFightFrame,startEntityFrame)
	self.fight = fight
	self.entity = entity
	self.lastFrame = lastTime * 30
	self.ignoreTimeScale = ignoreTimeScale
	self.startFightFrame = startFightFrame
	self.startEntityFrame = startEntityFrame
end

function StateSign:Refresh(lastTime,ignoreTimeScale,startFightFrame,startEntityFrame)
	self.lastFrame = lastTime * 30
	self.ignoreTimeScale = ignoreTimeScale
	self.startFightFrame = startFightFrame
	self.startEntityFrame = startEntityFrame
