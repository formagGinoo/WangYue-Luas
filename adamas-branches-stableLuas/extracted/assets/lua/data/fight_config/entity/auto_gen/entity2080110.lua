Config = Config or {}
Config.Entity2080110 = Config.Entity2080110 or { }
local empty = { }
Config.Entity2080110 = 
{
  [ 2080110 ] = {
    EntityId = 2080110,
    Components = {
      Transform = {
        Prefab = "CommonEntity/BigBellTower/Prefab/GamePlayTowerElevator.prefab",
        Model = "GamePlayTowerElevator",
        isClone = true,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
            ...
            BoneColliders = {
              {
                ...
                LocalPosition = { 0.0, 0.066, 0.0 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 6.61591, 0.317502737, 6.583252 },
