...
function Behavior920031:FinishSkill(instanceId,skillId,skillSign,skillType)
...
--function Behavior920031:CastSkill(instanceId,skillId,skillSign,skillType)
	--LogError("1")
--end



function Behavior920031:BreakSkill(instanceId,skillId,skillSign,skillType)
