LevelBehavior32000013 = BaseClass("LevelBehavior32000013",LevelBehaviorBase)
--梦魇初3-2


function LevelBehavior32000013.GetGenerates()
	local generates = {2000,70920021,70920031}
	return generates
end

function LevelBehavior32000013:__init(fight)
	self.fight = fight
end


function LevelBehavior32000013:Init()
	...
	self.monsterList =
	{
		[1] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon1" ,wave = 1 ,lev = 49 ,entityId = 70920021},  --1精英从士
		[2] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "mon2" ,wave = 2 ,lev = 49 ,entityId = 70920031},  --1精英从士
	}
...
function LevelBehavior32000013:Update()
	...
	if self.missionState == 0 then
		...
		local fp1 = BehaviorFunctions.GetTerrainPositionP("mon2",32000013)
...
function LevelBehavior32000013:CreatMonster(wave)
...
function LevelBehavior32000013:Death(instanceId,isFormationRevive)
	--计算怪物全部死亡
	for i,v in ipairs(self.monsterList) do
		--计算当前波次怪物死亡数
...
--BehaviorFunctions.ShowTip(32000013)
--end
...
function LevelBehavior32000013:__delete()
