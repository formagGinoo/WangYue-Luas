LevelBehavior200507004 = BaseClass("LevelBehavior200507004",LevelBehaviorBase)
--关卡测试关
function LevelBehavior200507004:__init(fight)
	self.fight = fight
end


function LevelBehavior200507004.GetGenerates()
	local generates = {900060,808011003,80801000301,790006000}
	return generates
end

function LevelBehavior200507004.GetMagics()
	local generates = {8080100030101,8080100030102}
	return generates
end

function LevelBehavior200507004:Init()
	--通用参数---------------------------------------------------------------------------------------------------------------------
...
function LevelBehavior200507004:Update()
...
function LevelBehavior200507004:Death(instanceId,isFormationRevive)
...
function LevelBehavior200507004:Die(attackInstanceId,dieInstanceId)
...
function LevelBehavior200507004:DuplicateCountdownFinish()
...
function LevelBehavior200507004:TimerCountFinish(timerId)
	if self.npcDead == false or self.yuelingDead == false then
		--self.gameLeftTime = BehaviorFunctions.ReturnDuplicateCountdownRemain()
		--if self.gameLeftTime <= 0 then
		BehaviorFunctions.SetDuplicateResult(false)
...
function LevelBehavior200507004:OnCountDownFinishEvent(levelId)
