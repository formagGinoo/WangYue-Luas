...
--技能释放判断
function Behavior1003:CastSkill(instanceId,skillId,skillType)
...
--技能打断判断
function Behavior1003:BreakSkill(instanceId,skillId,skillType)
...
function Behavior1003:EnterElementState(atkInstanceId,instanceId,element)
	if atkInstanceId == self.Me and BF.CheckEntity(instanceId) and element == FEET.Wood then
		...
		BF.AddBuff(self.Me,instanceId,1000025,1)
