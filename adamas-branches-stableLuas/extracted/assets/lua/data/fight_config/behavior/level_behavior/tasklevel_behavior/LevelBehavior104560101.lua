LevelBehavior104560101 = BaseClass("LevelBehavior104560101",LevelBehaviorBase)


function LevelBehavior104560101.GetGenerates()
	local generates = {791004001,790012000,900050}
	return generates
end

function LevelBehavior104560101:__init(fight)
	self.fight = fight
end


function LevelBehavior104560101:Init()
	...
	self.monsterList =
	{
		[1] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "Mon01" ,wave = 1 ,lev = 0 ,enemyType = "monster",entityId = 791004001},  --弓从士
		[2] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "Mon02" ,wave = 1 ,lev = 0 ,enemyType = "monster",entityId = 790012000},  --弓从士
		[3] = {Id = nil , state = self.monsterStateEnum.Default ,bp = "Mon03" ,wave = 1 ,lev = 0 ,enemyType = "monster",entityId = 790012000},  --1盾牌
	}

end

function LevelBehavior104560101:Update()
	...
	if self.missionState == 2 and self.deathCount > 2 then
		...
		BehaviorFunctions.FinishLevel(104560101)
		self.missionState = 3
	end
...
function LevelBehavior104560101:CreatMonster(wave)
...
function LevelBehavior104560101:Die(attackInstanceId,dieInstanceId)
...
function LevelBehavior104560101:__delete()
