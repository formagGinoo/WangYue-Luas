LevelBehavior200507002 = BaseClass("LevelBehavior200507002",LevelBehaviorBase)
--关卡测试关
function LevelBehavior200507002:__init(fight)
	self.fight = fight
end


function LevelBehavior200507002.GetGenerates()
	local generates = {910025,808011003,80801000301,791002500}
	return generates
end

function LevelBehavior200507002.GetMagics()
	local generates = {8080100030101,8080100030102}
	return generates
end

function LevelBehavior200507002:Init()
	--通用参数---------------------------------------------------------------------------------------------------------------------
	...
	self.monsterList = {
		...
		{id = 791002500,posName = "mon2", wave = 1}
		}
	----------------------------------------------------------
...
function LevelBehavior200507002:Update()
...
function LevelBehavior200507002:Death(instanceId,isFormationRevive)
...
function LevelBehavior200507002:Die(attackInstanceId,dieInstanceId)
...
function LevelBehavior200507002:DuplicateCountdownFinish()
...
function LevelBehavior200507002:TimerCountFinish(timerId)
	if self.npcDead == false or self.yuelingDead == false then
		--self.gameLeftTime = BehaviorFunctions.ReturnDuplicateCountdownRemain()
		--if self.gameLeftTime <= 0 then
		BehaviorFunctions.SetDuplicateResult(false)
...
function LevelBehavior200507002:OnCountDownFinishEvent(levelId)
