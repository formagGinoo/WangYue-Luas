...
function Assembler:CreateEntity(instanceId,entityId,parent, sInstanceId, params)
...
function Assembler:CreateComponents(entity)
	...
	self:AddComponent(entity, "hackingInputHandleComponent", ComponentType.HackingInputHandle, HackingInputHandleComponent)
	self:AddComponent(entity, "customFSMComponent", ComponentType.CustomFSM, CustomFSMComponent)
	self:AddComponent(entity, "movePlatformComponent", ComponentType.MovePlatform, MovePlatformComponent)
	self:AddComponent(entity, "blowComponent", ComponentType.Blow, BlowComponent)
	self:AddComponent(entity, "jointComponent", ComponentType.Joint, JointComponent)
	self:AddComponent(entity, "displayComponent", ComponentType.Display, DisplayComponent)
end
...
function Assembler:AddClientComponent(clientEntity, entityId, componentType, componentName, componentClass)
	...
	if ctx then
		if configInfo then
			...
			clientEntity.entity[componentName] = component
			return component
		end	
	end
