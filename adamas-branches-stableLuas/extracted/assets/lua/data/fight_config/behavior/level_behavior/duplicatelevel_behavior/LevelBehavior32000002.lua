LevelBehavior32000002 = BaseClass("LevelBehavior32000002",LevelBehaviorBase)
--资源收集-约币收集：从士火本   --难度1

function LevelBehavior32000002.GetGenerates()
	local generates = {2000,900040,900041,900050,900051,910040}
	return generates
end

function LevelBehavior32000002:__init(fight)
	self.fight = fight
end


function LevelBehavior32000002:Init()
...
function LevelBehavior32000002:Update()
	...
	if self.missionState == 0 then
		...
		--设置关卡相机
		local fp1 = BehaviorFunctions.GetTerrainPositionP("mon2",32000002)
...
function LevelBehavior32000002.NeedBlackCurtain()
	return true, 1
end

function LevelBehavior32000002:CreatMonster(wave)
...
function LevelBehavior32000002:Death(instanceId,isFormationRevive)
	--计算怪物全部死亡
...
function LevelBehavior32000002:__delete()
