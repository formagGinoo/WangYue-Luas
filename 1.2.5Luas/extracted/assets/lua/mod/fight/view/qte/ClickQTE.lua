...
function ClickQTE:__Show()
    ...
    self.Time:SetActive(self.setting.isShowCountDown)
...
function ClickQTE:OnExitQTE(isSuccess)
    ...
    --        local aryParticleSystems = effectInfo.object:GetComponentsInChildren(ParticleSystem)
    --        for i = 0, aryParticleSystems.Length - 1 do
    --            local eachParticleSystem = aryParticleSystems[i]
    --            print(eachParticleSystem.main.startColor.color.r, eachParticleSystem.main.startColor.color.g,
    --                    eachParticleSystem.main.startColor.color.b, 0.1)
    --            eachParticleSystem.main.startColor = Color(eachParticleSystem.main.startColor.color.r, eachParticleSystem.main.startColor.color.g,
    --                    eachParticleSystem.main.startColor.color.b, 0.1)
    --        end
    --    end
    --end
