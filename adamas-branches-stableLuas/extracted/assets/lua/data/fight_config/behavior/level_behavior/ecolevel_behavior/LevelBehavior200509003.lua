LevelBehavior200509003 = BaseClass("LevelBehavior200509003",LevelBehaviorBase)
--关卡测试关
function LevelBehavior200509003:__init(fight)
	self.fight = fight
end


function LevelBehavior200509003.GetGenerates()
...
function LevelBehavior200509003.GetMagics()
	local generates = {200000017}
	return generates
end

function LevelBehavior200509003:Init()
	--通用参数---------------------------------------------------------------------------------------------------------------------
	...
	self.ecoMe = 2003001092031 --自己生态id
	...
	self.npc = {
		[1] = {id = nil, pos = nil, rot = nil, entity = 8011001, isEnemy = false,ecoId = 5003001092031,ecoPos = "npc1"},
		[2] = {id = nil, pos = nil, rot = nil, entity = 8011002, isEnemy = false,ecoId = 5003001092032,ecoPos = "npc2"},
		[3] = {id = nil, pos = nil, rot = nil, entity = 8011003, isEnemy = false,ecoId = 5003001092033,ecoPos = "npc3"},
		[4] = {id = nil, pos = nil, rot = nil, entity = 8010004, isEnemy = false, ecoId = 5003001092035,ecoPos = "npc5"},
		[5] = {id = nil, pos = nil, rot = nil, entity = 8010004, isEnemy = true,ecoId = 5003001092036,ecoPos = "npc6"},
...
function LevelBehavior200509003:Update()
...
function LevelBehavior200509003:Die(attackInstanceId,dieInstanceId)
...
----死亡
--function LevelBehavior200509003:Death(instanceId,isFormationRevive)
...
--与NPC互动
function LevelBehavior200509003:WorldInteractClick(uniqueId,instanceId)
...
--对话开始
function LevelBehavior200509003:StoryStartEvent(dialogId)
	--开始战斗的对话
...
--对话结束
function LevelBehavior200509003:StoryEndEvent(dialogId)
	if dialogId == self.battleDialog then
...
--播放特定对话
function LevelBehavior200509003:StoryPassEvent(dialogId)
	--如果播放警察的请求对话
...
--拦截短信
function LevelBehavior200509003:HackingClickUp(instanceId)
	if instanceId == self.monster.id then
...
--输入按键
function LevelBehavior200509003:KeyInput(key, status)
...
--检查npc生成状态
function LevelBehavior200509003:CheckNPC(npcList)
	if self.monster.id then
...
--播放动作
function LevelBehavior200509003:PlayAnimationHuishou(instanceId,ani,Loop,aniFrameCD,aniInFrameCD,aniLoopFrameCD,aniEndFrameCD)
...
function LevelBehavior200509003:OnAttackNpc(attackInstanceId,hitInstanceId,instanceId,attackType, skillType)
