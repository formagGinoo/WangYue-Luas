...
function Behavior999901:Update()
	...
	function Behavior999901:CastSkill(instanceId,skillId,skillType)
		
		
		--如果玩家释放闪避，则逼近玩家：
		if instanceId == self.battleTarget and skillType == 1 and BF.GetEntityState(self.me) ~= FightEnum.EntityState.Skill  then
		...
		if instanceId == self.battleTarget and BF.GetEntityState(self.me) ~= FightEnum.EntityState.Skill  then
			...
			if  skillType == 1 or skillType == 10 or skillType == 20 or skillType == 70 then
