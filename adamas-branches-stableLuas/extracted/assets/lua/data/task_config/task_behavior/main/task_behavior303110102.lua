TaskBehavior303110102 = BaseClass("TaskBehavior303110102")

function TaskBehavior303110102.GetGenerates()
	local generates = {}
	return generates
end

function TaskBehavior303110102:__init(taskInfo)
...
function TaskBehavior303110102:Update()
	-- print("TaskBehavior303110102初始化")
	...
	elseif self.missionState == 1 then
		BehaviorFunctions.SendTaskProgress(3031101,2,1,1)
		self.missionState = 3
		-- print("303030105任务结束")
	end
end
...
--设置关卡相机函数
function TaskBehavior303110102:SetLevelCamera()
