TaskBehavior105040401 = BaseClass("TaskBehavior105040401")
--第三章通用模板

function TaskBehavior105040401.GetGenerates()
	local generates = {}
	return generates
end

function TaskBehavior105040401:__init(taskInfo)
...
function TaskBehavior105040401:Update()
