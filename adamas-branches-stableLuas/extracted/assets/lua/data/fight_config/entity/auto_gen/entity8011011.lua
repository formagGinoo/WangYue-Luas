Config = Config or {}
Config.Entity8011011 = Config.Entity8011011 or { }
local empty = { }
Config.Entity8011011 = 
{
  [ 8011011 ] = {
    EntityId = 8011011,
    Components = {
      Transform = {
        Prefab = "Character/Npc/Female165/FemaleNpc01011/FemaleNpc01011.prefab",
        Model = "FemaleNpc01011",
        isClone = false,
        MinDistance = 0.0,
        MaxDistance = 1.0,
        MinTranslucent = 0.0,
      ...
      HackingInputHandle = {
        HackingType = 3,
        Name = "警察",
        Icon = "Textures/Icon/Single/HeadIcon/SquNJingjujiedai.png",
        Desc = "",
        EffectType = 2,
