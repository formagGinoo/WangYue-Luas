Config = Config or {}
Config.Entity2040841 = Config.Entity2040841 or { }
local empty = { }
Config.Entity2040841 = 
{
  [ 2040841 ] = {
    EntityId = 2040841,
    Components = {
      Transform = {
        Prefab = "CommonEntity/Vehicle/Taxi/Prefab/Taxi00101.prefab",
        Model = "Taxi00101",
        isClone = true,
        MinDistance = 0.0,
        MaxDistance = 1.0,
            ...
            BoneColliders = {
              {
                ShapeType = 2,
                ParentName = "Collider",
                LocalPosition = { 0.0, 1.0, 0.09 },
                LocalEuler = { 0.0, 0.0, 0.0 },
                LocalScale = { 2.17350841, 1.69809854, 4.46765566 },
      ...
      Animator = {
        Animator = "CommonEntity/Vehicle/Taxi/Animation/Taxi001/Taxi001.controller",
        AnimationConfigID = "",
