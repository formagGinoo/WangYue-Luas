...
--攻击有【施毒】的敌人伤害增加
function Behavior6000021:BeforeDamage(InstanceId,hitInstanceId,damageType,magicId,damageElementType,damageVal,attackType,
		partType,damageInfo,attackInstanceId,isCirt)
	
	--判断受击方是否有【施毒】状态
	if attackInstanceId == self.me and BF.HasBuffKind(hitInstanceId,6000030) then	
		damageInfo.damage = damageInfo.damage * self.damageUp	--本次伤害增加
	end
end