...
local AtomizeConfig = {
	{
		ecoId = 0,
		locationType = FightEnum.AtomizePointLocationType.OutDoor,
		interactType = FightEnum.AtomizePointInteractType.Both,
		OutoffsetY = 0,
...
function LevelBehavior31010.GetGenerates()
	local generates = {92003,900050,910040,900040,900050,900041,900042,900030,2040901,2040902}
	return generates
end
...
function LevelBehavior31010:Update()
	...
	if self.missionState == 0  then
		...
		----self.monster1 = BehaviorFunctions.CreateEntity(900041,nil,pos.x+4,pos.y,pos.z)
		...
		----self.monster3 = BehaviorFunctions.CreateEntity(900040,nil,pos.x+8,pos.y,pos.z)
		
		--self.thing1 = BehaviorFunctions.CreateEntity(2040901,nil,pos.x+1,pos.y,pos.z)
		--self.thing2 = BehaviorFunctions.CreateEntity(2040901,nil,pos.x+6,pos.y+10,pos.z)
		
		
		
		--AtomizeConfig[1].ecoId = self.thing1
		--AtomizeConfig[2].ecoId = self.thing2
		
		--local point = BehaviorFunctions.GetEntity(self.thing1)
		--point:CallBehaviorFun("SetAtomizePointConfig",AtomizeConfig[1],AtomizeConfig)
		
		--point = BehaviorFunctions.GetEntity(self.thing2)
		--point:CallBehaviorFun("SetAtomizePointConfig",AtomizeConfig[2],AtomizeConfig)
		--self.thing = BehaviorFunctions.CreateEntity(2040901,nil,pos.x+1,pos.y,pos.z)
...
--function LevelBehavior31010:CastSkill(instanceId,skillId,skillSign,skillType)
