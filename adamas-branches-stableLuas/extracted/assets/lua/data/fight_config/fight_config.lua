...
FightConfig.TipsFontPoint = "HitCase"
FightConfig.TipsFont =
{
	[1] = {name = "闪"}, --极限闪避
	[2] = {name = "绝"}, --气绝状态
	[3] = {name = "破"}, --五行击破
...
FightConfig.FontOffsetPos =
{
	...
	[FightConfig.FontRangePosType.Tips] = Vec3.New(0,0,0),
}
...
FightConfig.FontRangePos =
{
	...
	[FightConfig.FontRangePosType.Tips] = {rangeMinX = -50, rangeMaxX = 50, rangeMinY = 30, rangeMaxY = 60 },
}
...
-- 节点显示类型配置
FightConfig.NodeVisibleDefine = 
{
	["PanelParent"] = FightConfig.NodeVisibleType.Position,
}
